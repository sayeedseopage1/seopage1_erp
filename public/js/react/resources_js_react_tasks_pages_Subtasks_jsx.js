          ...
          case 0:
            ...
            return getAllSubtask("".concat(queryString)).unwrap().then(function (res) {
              ...
              if (auth.getRoleId() === 4) {
                ...
                _data = lodash__WEBPACK_IMPORTED_MODULE_0___default().filter(res.tasks, function (d) {
                  return Number(d.assigned_to_id) === auth.getId() || Number(d.added_by) === auth.getId();
                });
              }
              ...
              var _console;
              return (/* eslint-disable */(_console = console).log.apply(_console, _toConsumableArray(oo_oo("2286167511_91_32_91_48_4", err)))
              );
            });
          case 6:
          case "end":
