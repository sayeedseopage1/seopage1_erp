        ...
        while (1) switch (_context.prev = _context.next) {
          case 0:
            ...
            return getAllSubtask("".concat(queryString)).unwrap().then(function (res) {
              ...
              var _console;
              return (/* eslint-disable */(_console = console).log.apply(_console, _toConsumableArray(oo_oo("2539096054_82_32_82_48_4", err)))
              );
            });
          case 6:
          case "end":
