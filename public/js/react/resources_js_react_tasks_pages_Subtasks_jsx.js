...
/* harmony import */ var _tanstack_react_table__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(/*! @tanstack/react-table */ "./node_modules/@tanstack/react-table/build/lib/index.mjs");
/* harmony import */ var _tanstack_react_table__WEBPACK_IMPORTED_MODULE_18__ = __webpack_require__(/*! @tanstack/react-table */ "./node_modules/@tanstack/table-core/build/lib/index.mjs");
/* harmony import */ var lodash__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! lodash */ "./node_modules/lodash/lodash.js");
/* harmony import */ var lodash__WEBPACK_IMPORTED_MODULE_3___default = /*#__PURE__*/__webpack_require__.n(lodash__WEBPACK_IMPORTED_MODULE_3__);
/* harmony import */ var _TasksTablePagination__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./TasksTablePagination */ "./resources/js/react/tasks/components/TasksTablePagination.jsx");
/* harmony import */ var dayjs__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! dayjs */ "./node_modules/dayjs/dayjs.min.js");
/* harmony import */ var dayjs__WEBPACK_IMPORTED_MODULE_5___default = /*#__PURE__*/__webpack_require__.n(dayjs__WEBPACK_IMPORTED_MODULE_5__);
/* harmony import */ var _loader_TaskTableLoader__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./loader/TaskTableLoader */ "./resources/js/react/tasks/components/loader/TaskTableLoader.jsx");
/* harmony import */ var react_redux__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! react-redux */ "./node_modules/react-redux/es/index.js");
/* harmony import */ var _Dropdown__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./Dropdown */ "./resources/js/react/tasks/components/Dropdown.jsx");
/* harmony import */ var _Button__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./Button */ "./resources/js/react/tasks/components/Button.jsx");
/* harmony import */ var _Timer__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./Timer */ "./resources/js/react/tasks/components/Timer.jsx");
...
/* harmony import */ var _Person__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./Person */ "./resources/js/react/tasks/components/Person.jsx");
/* harmony import */ var _table_DragableColumnHeader__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ./table/DragableColumnHeader */ "./resources/js/react/tasks/components/table/DragableColumnHeader.jsx");
/* harmony import */ var _ReportButton__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ./ReportButton */ "./resources/js/react/tasks/components/ReportButton.jsx");
...
function SubTasksTable(_ref) {
  ...
  var defaultColumns = react__WEBPACK_IMPORTED_MODULE_0__.useMemo(function () {
    return [{
      ...
      cell: function cell(_ref3) {
        ...
        var subtaskCount = lodash__WEBPACK_IMPORTED_MODULE_3___default().size(data === null || data === void 0 ? void 0 : data.subtasks_count);
        var isActive = count > 0;
        var serverTime = 0;
        var localTime = 0;
        var timer = 0;
        if (data !== null && data !== void 0 && data.start_time && lodash__WEBPACK_IMPORTED_MODULE_3___default().isNull(data === null || data === void 0 ? void 0 : data.end_time)) {
        ...
        var clockIsRunning = (data === null || data === void 0 ? void 0 : data.start_time) && lodash__WEBPACK_IMPORTED_MODULE_3___default().isNull(data === null || data === void 0 ? void 0 : data.end_time);
        ...
        return /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_16__.jsxs)("div", {
          ...
          children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_16__.jsx)("i", {
            ...
            children: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_16__.jsx)(_Timer__WEBPACK_IMPORTED_MODULE_10__["default"], {
              time: timer,
              run: clockIsRunning
            })
          })]
      ...
      cell: function cell(_ref7) {
        ...
        return /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_16__.jsx)("div", {
          children: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_16__.jsx)(_Person__WEBPACK_IMPORTED_MODULE_12__["default"], {
      ...
      cell: function cell(_ref8) {
        var row = _ref8.row;
        var data = row === null || row === void 0 ? void 0 : row.original;
        return /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_16__.jsx)(_Person__WEBPACK_IMPORTED_MODULE_12__["default"], {
      ...
      cell: function cell(_ref10) {
        ...
        date = date === 'Today' ? date : dayjs__WEBPACK_IMPORTED_MODULE_5___default()(date).format('DD-MM-YYYY');
        return /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_16__.jsx)("span", {
          style: {
            color: color
          },
      ...
      cell: function cell(_ref11) {
        ...
        return /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_16__.jsx)("strong", {
          children: data !== null && data !== void 0 && data.start_date ? /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_16__.jsxs)(react_jsx_runtime__WEBPACK_IMPORTED_MODULE_16__.Fragment, {
            children: [dayjs__WEBPACK_IMPORTED_MODULE_5___default()(data === null || data === void 0 ? void 0 : data.start_date).format('DD-MM-YYYY'), " ", /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_16__.jsx)("br", {})]
          }) : '--'
        });
      }
    }, {
      ...
      cell: function cell(_ref12) {
        ...
        return /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_16__.jsx)("strong", {
          children: Number(data === null || data === void 0 ? void 0 : data.board_column_id) === 4 ? (data === null || data === void 0 ? void 0 : data.completion_date) && /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_16__.jsxs)(react_jsx_runtime__WEBPACK_IMPORTED_MODULE_16__.Fragment, {
            children: [dayjs__WEBPACK_IMPORTED_MODULE_5___default()(data === null || data === void 0 ? void 0 : data.completion_date).format('DD-MM-YYYY'), " ", /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_16__.jsx)("br", {})]
          }) : '--'
        });
      }
    }, {
      ...
      cell: function cell(_ref13) {
        ...
        return /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_16__.jsx)("strong", {
          children: data !== null && data !== void 0 && data.task_approval_date ? /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_16__.jsx)(react_jsx_runtime__WEBPACK_IMPORTED_MODULE_16__.Fragment, {
            children: dayjs__WEBPACK_IMPORTED_MODULE_5___default()(data === null || data === void 0 ? void 0 : data.task_approval_date).format('DD-MM-YYYY')
      ...
      cell: function cell(_ref15) {
        ...
        var data = row === null || row === void 0 ? void 0 : row.original;
        return /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_16__.jsx)("div", {
          children: (0,_utils_converTime__WEBPACK_IMPORTED_MODULE_1__.convertTime)(data === null || data === void 0 ? void 0 : data.subtasks_hours_logged)
        });
      }
    }, {
      id: 'assigned_by',
      ...
      cell: function cell(_ref20) {
        var row = _ref20.row;
        var data = row === null || row === void 0 ? void 0 : row.original;
        return /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_16__.jsx)(_ReportButton__WEBPACK_IMPORTED_MODULE_14__["default"], {
          row: data
        });
      }
    }, {
      ...
      cell: function cell(_ref21) {
        ...
        var data = row === null || row === void 0 ? void 0 : row.original;
        return /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_16__.jsx)("div", {
          children: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_16__.jsxs)(_Dropdown__WEBPACK_IMPORTED_MODULE_8__["default"], {
            children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_16__.jsx)(_Dropdown__WEBPACK_IMPORTED_MODULE_8__["default"].Toggle, {
              icon: false,
              children: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_16__.jsx)(_Button__WEBPACK_IMPORTED_MODULE_9__["default"], {
                variant: "tertiary",
                children: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_16__.jsx)("i", {
                  className: "fa-solid fa-ellipsis-vertical"
                })
              })
            }), /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_16__.jsxs)(_Dropdown__WEBPACK_IMPORTED_MODULE_8__["default"].Menu, {
              className: "p-1",
              children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_16__.jsxs)(_Dropdown__WEBPACK_IMPORTED_MODULE_8__["default"].Item, {
                className: "sp1_tasks_tbl_action",
                children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_16__.jsx)("i", {
                  className: "fa-regular fa-pen-to-square mr-2"
                }), "Edit"]
              }), /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_16__.jsxs)(_Dropdown__WEBPACK_IMPORTED_MODULE_8__["default"].Item, {
  ...
  react__WEBPACK_IMPORTED_MODULE_0__.useEffect(function () {
    ...
    var auth = new _utils_user_details__WEBPACK_IMPORTED_MODULE_15__.User((_window = window) === null || _window === void 0 ? void 0 : (_window$Laravel = _window.Laravel) === null || _window$Laravel === void 0 ? void 0 : _window$Laravel.user);
    var _cols = _toConsumableArray(defaultColumns);
    if (!lodash__WEBPACK_IMPORTED_MODULE_3___default().includes(reportPermission, auth === null || auth === void 0 ? void 0 : auth.getRoleId())) {
      var cols = _cols === null || _cols === void 0 ? void 0 : _cols.filter(function (col) {
        return col.id !== 'report';
      });
      setColumns(_toConsumableArray(cols));
    }
  }, []);
  ...
  // table instance...
  var table = (0,_tanstack_react_table__WEBPACK_IMPORTED_MODULE_17__.useReactTable)({
    data: data,
    columns: columns,
    state: {
      sorting: sorting,
    ...
    getCoreRowModel: (0,_tanstack_react_table__WEBPACK_IMPORTED_MODULE_18__.getCoreRowModel)(),
    getPaginationRowModel: (0,_tanstack_react_table__WEBPACK_IMPORTED_MODULE_18__.getPaginationRowModel)(),
    getFilteredRowModel: (0,_tanstack_react_table__WEBPACK_IMPORTED_MODULE_18__.getFilteredRowModel)(),
    getExpandedRowModel: (0,_tanstack_react_table__WEBPACK_IMPORTED_MODULE_18__.getExpandedRowModel)(),
    getSortedRowModel: (0,_tanstack_react_table__WEBPACK_IMPORTED_MODULE_18__.getSortedRowModel)(),
            ...
            return /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_16__.jsx)("tr", {
              ...
              children: row.getVisibleCells().map(function (cell) {
                return /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_16__.jsx)("td", {
                  ...
                  children: (0,_tanstack_react_table__WEBPACK_IMPORTED_MODULE_17__.flexRender)(cell.column.columnDef.cell, cell.getContext())
                }, cell.id);
              })
            }, row.id);
