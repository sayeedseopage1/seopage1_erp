"use strict";
(self["webpackChunk"] = self["webpackChunk"] || []).push([["resources_js_components_single-task_section_task-actions_stop-timer_options_DevloperTaskSelec-9c8548"],{

/***/ "./resources/js/components/single-task/section/task-actions/stop-timer/options/DevloperTaskSelectionMenu.jsx":
/*!*******************************************************************************************************************!*\
  !*** ./resources/js/components/single-task/section/task-actions/stop-timer/options/DevloperTaskSelectionMenu.jsx ***!
  \*******************************************************************************************************************/
...
/* harmony import */ var _utils_user_details__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../../../../utils/user-details */ "./resources/js/components/utils/user-details.js");
/* harmony import */ var _services_api_SingleTaskPageApi__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../../../../services/api/SingleTaskPageApi */ "./resources/js/components/services/api/SingleTaskPageApi.js");
...
var DevloperTaskSelectionMenu = function DevloperTaskSelectionMenu(_ref) {
  ...
  var user = new _utils_user_details__WEBPACK_IMPORTED_MODULE_2__.User((_window = window) === null || _window === void 0 ? void 0 : (_window$Laravel = _window.Laravel) === null || _window$Laravel === void 0 ? void 0 : _window$Laravel.user);
      ...
      children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_4__.jsxs)(_headlessui_react__WEBPACK_IMPORTED_MODULE_5__.Combobox.Button, {
        ...
        children: filteredDeveloperTask && filteredDeveloperTask.length ? filteredDeveloperTask === null || filteredDeveloperTask === void 0 ? void 0 : filteredDeveloperTask.map(function (task) {
          return /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_4__.jsx)(_headlessui_react__WEBPACK_IMPORTED_MODULE_5__.Combobox.Option, {
            ...
            children: task === null || task === void 0 ? void 0 : task.heading
          }, task.id);
...
//# sourceMappingURL=resources_js_components_single-task_section_task-actions_stop-timer_options_DevloperTaskSelec-9c8548.js.map