...
@push('scripts')
    ...
    <script>
        ...
        $('#dm-deals-table').on('preXhr.dt', function(e, settings, data) {
        ...
        const showTable = () => {
            window.LaravelDataTables["dm-deals-table"].draw();
        }
        ...
        const applyQuickAction = () => {
            var rowdIds = $("#dm-deals-table input:checkbox:checked").map(function() {
                return $(this).val();
            }).get();
