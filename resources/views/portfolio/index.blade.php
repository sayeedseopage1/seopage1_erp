...
{{--                                    <select name="website_sub_cat" id="website_sub_cat" data-live-search="true" class="w-100 form-control select-picker" data-size="8">--}}
                        ...
                        <div class="displayFilterData">
                            <p class="mt-2 f-18"
                               style="color:#5e6168; font-weight: 500">Website Category: <span id="displaySelectedCategory">--</span></p>
                ...
                if (website_cat_id) {
                    $.ajax({
                        ...
                        success: function (data) {
                            ...
                            $('#website_sub_cat').append('<option value="">--</option>');
