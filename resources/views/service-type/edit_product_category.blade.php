...
@section('content')
@php
$sales_product_category = \App\Models\SalesProductCategory::where('product_cat_callection_id',$product_category->id)->first();
...
<div class="container-fluid">
            ...
            <div class="col-12">
                <div class="card mb-2 mt-3">
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-8">
                                <p>{{$product_category->deal_id}}</p>
                            </div>
                            <div class="col-4">
                                <p>Client Link</p>
                            </div>
                            <div class="col-8">
                                <p>{{$product_category->client_link}}</p>
                            </div>
                            <div class="col-4">
                                <p>Client Name</p>
                            </div>
                            ...
                            <div class="col-8">
                                <p>{{$product_category->service_type}}</p>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-8">
                                ...
                                <div id="website_link_container">
                                    @if($sales_product_category != null)
                                        <p>{{$sales_product_category->website_link}}</p>
                                    @else
                                        @if($product_category->website_link ?? null)
                                            <button id="website_link_btn" type="button" style="background-color: #ffffff" onclick="toggleWebsiteLinkButton()" data-toggle="tooltip" data-placement="top" title="Click to edit">{{$product_category->website_link}}</button>
                                        @else
                                ...
                                <div id="website_link_form">
                                    @if($product_category->website_link)
                                    <form action="" method="post">
                                        @csrf
                                        <div class="input-group" id="input_website_link" style="display: none; margin-top: -10px;">
                                            <input type="url" id="website_link" value="{{$product_category->website_link}}" name="website_link" class="form-control height-35 f-14" aria-label="Recipient's username" aria-describedby="saveButton" placeholder="Enter website URL (https://asdasd.com)">
                                            <div class="input-group-append">
                                                <button class="btn btn-outline-secondary saveWebsiteLinkBtn" type="button" id="saveButton" data-id="{{$product_category->id}}"><i class="fa-solid fa-check"></i></button>
                                            </div>
                                        </div>
                                ...
                                <div id="website_niche_container">
                                    @if($sales_product_category && $sales_product_category->website_niche != null)
                                        <p>{{$sales_product_category->website_niche}}</p>
                                    @else
                                        @if($product_category && $product_category->website_niche)
                                            <button id="website_niche_btn" type="button" style="background-color: #ffffff" onclick="toggleWebsiteNicheButton()" data-toggle="tooltip" data-placement="top" title="Click to edit">{{$product_category->website_niche}}</button>
                                        @else
                                ...
                                <div id="website_niche_form">
                                    @if($product_category->website_niche)
                                    <form action="" method="post">
                                        @csrf
                                        <div class="input-group" id="input_website_niche" style="display: none; margin-top: -10px;">
                                            <input type="url" id="website_niche" value="{{$product_category->website_niche}}" name="website_niche" class="form-control height-35 f-14" aria-label="Recipient's username" aria-describedby="saveButton" placeholder="Write Your Niche (Pet Care, Digital Marketing)">
                                            <div class="input-group-append">
                                                <button class="btn btn-outline-secondary saveWebsiteNicheBtn" type="button" id="saveButton" data-id="{{$product_category->id}}"><i class="fa-solid fa-check"></i></button>
                                            </div>
                                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-8">
                                <div id="website_name_container">
                                    @if($sales_product_category && $sales_product_category->website_name != null)
                                    <p>{{$sales_product_category->website_name}}</p>
                                    @else
                                    @if($product_category && $product_category->website_name)
                                    <button id="website_name_btn" type="button" style="background-color: #ffffff" onclick="toggleWebsiteNameButton()" data-toggle="tooltip" data-placement="top" title="Click to edit"> {{$product_category->website_name}}</button>
                                    @else
                                ...
                                <div id="website_name_form">
                                    @if($product_category->website_name)
                                    <form action="" method="post">
                                        @csrf
                                        <div class="input-group" id="input_website_name" style="display: none; margin-top: -10px;">
                                            <input type="text" id="website_name" value="{{$product_category->website_name}}" name="website_name" class="form-control height-35 f-14" aria-label="Recipient's username" aria-describedby="saveButton" placeholder="Type Your Business/Website Name">
                                            <div class="input-group-append">
                                                <button class="btn btn-outline-secondary saveWebsiteNameBtn" type="button" id="saveButton" data-id="{{$product_category->id}}"><i class="fa-solid fa-check"></i></button>
                                            </div>
                                        </div>
                ...
                <div class="card mb-2">
                    <div class="card-body">
                        <div class="row">
                            ...
                            @if($sales_product_category && $sales_product_category->business_information != null)
                            <div class="col-8">
                                <p>{{$sales_product_category->business_information}}</p>
                            </div>
                            @else
                            <div class="col-8" id="business_information_value" onclick="toggleBusinessInformationEdit()">
                                <div id="business_information_container">
                                    @if($product_category && $product_category->business_information)
                                    <button id="business_information_btn" type="button" style="background-color: #ffffff"  data-toggle="tooltip" data-placement="top" title="Click to edit"> {{$product_category->business_information}}</button>
                                    @else
                            ...
                            @if($sales_product_category !=null)
                            <div class="col-8">
                                @if($sales_product_category->share_file_info ==1)
                                    <p>Yes</p>
                                @else
                                    <p>No</p>
                                @endif
                            ...
                            @else
                            <div class="col-8" id="business_information_value" onclick="toggleBusinessInformationEdit()">
                                @if($product_category->share_file_info ==1)
                            ...
                            @if(isset($sales_product_category) && $sales_product_category->share_file_info == 1)
                                <div class="col-4"></div>
                                <div class="col-8">
                                    @php
                            ...
                            @else
                                @if(isset($product_category) && $product_category->share_file_info == 1)
                                    <div class="col-4"></div>
                                    <div class="col-8" id="business_information_value" onclick="toggleBusinessInformationEdit()">
                                        @php
                                            if (is_string($product_category->folder_link) && is_array(json_decode($product_category->folder_link, true))) {
                                                $array = json_decode($product_category->folder_link, true);
                                                $folder_links = implode(', ', $array);
                                            }
                                            else {
                                                $folder_links = '';
                        ...
                        @include('service-type.modal.product-category.business_information_edit_modal')
                    </div>
                </div>
                ...
                <div class="card mb-2">
                    <div class="card-body">
                        <div class="row">
                            <div class="col-4">
                                <p>Reference product category/collection page description for the tone and style:</p>
                            </div>
                            @if($sales_product_category && $sales_product_category->category_url != null)
                                <div class="col-8">
                                    @php
                                        if (is_string($sales_product_category->category_url) && is_array(json_decode($sales_product_category->category_url, true))) {
                            ...
                            @else
                                <div class="col-8" id="reference_blog_value" onclick="toggleReferenceBlogEdit()">
                                    @php
                                        if (is_string($product_category->category_url) && is_array(json_decode($product_category->category_url, true))) {
                                            $array = json_decode($product_category->category_url, true);
                                            $category_urls = implode(', ', $array);
                                        }
                                        $category_urls_array = explode(', ', $category_urls);
                                    @endphp
                                    ...
                                    @foreach($category_urls_array as $category_url)
                                        @if($category_url)
                                        <p data-toggle="tooltip" data-placement="top" title="Click to edit">{{$category_url}}</p>
                                        @else
                                        <p data-toggle="tooltip" data-placement="top" title="Click to edit">--</p>
                                        @endif
                                    @endforeach
                        ...
                        @include('service-type.modal.product-category.reference_blog_edit_modal')
                    </div>
                </div>
                ...
                <div class="card mb-2">
                    <div class="card-body">
                        <div class="row">
                            <div class="col-4">
                                <p>How many product category/collection pages do you need written</p>
                            </div>
                            <div class="col-8">
                                <div id="product_no_container">
                                    @if($sales_product_category && $sales_product_category->product_no != null)
                                    <p>{{$sales_product_category->product_no}}</p>
                                    @else
                                    @if($product_category && $product_category->product_no)
                                    <button id="product_no_btn" type="button" style="background-color: #ffffff" onclick="toggleProductNoButton()" data-toggle="tooltip" data-placement="top" title="Click to edit"> {{$product_category->product_no}}</button>
                                    @else
                                ...
                                <div id="product_no_form">
                                    @if($product_category->product_no)
                                    <form action="" method="post">
                                        @csrf
                                        <div class="input-group" id="input_product_no" style="display: none; margin-top: -10px;">
                                            <input type="text" id="product_no" value="{{$product_category->product_no}}" name="product_no" class="form-control height-35 f-14" aria-label="Recipient's username" aria-describedby="saveButton" placeholder="Input word count here!">
                                            <div class="input-group-append">
                                                <button class="btn btn-outline-secondary saveProductNoBtn" type="button" id="saveButton" data-id="{{$product_category->id}}"><i class="fa-solid fa-check"></i></button>
                                            </div>
                                        </div>
                ...
                <div class="card mb-2">
                    <div class="card-body">
                        <div class="row">
                            <div class="col-4">
                                <p>List of product category/collection pages that need texts:</p>
                            </div>
                            @if($sales_product_category && $sales_product_category->category_list != null)
                                <div class="col-8">
                                    @php
                                        if (is_string($sales_product_category->category_list) && is_array(json_decode($sales_product_category->category_list, true))) {
                            ...
                            @else
                                <div class="col-8" id="product_list_value" onclick="toggleProductListEdit()">
                                    @php
                                        if (is_string($product_category->category_list) && is_array(json_decode($product_category->category_list, true))) {
                                            $array = json_decode($product_category->category_list, true);
                                            $category_lists = implode(', ', $array);
                                        }
                                        $category_lists_array = explode(', ', $category_lists);
                                    @endphp
                                    ...
                                    @foreach($category_lists_array as $category_list)
                                        @if($category_list)
                                        <p data-toggle="tooltip" data-placement="top" title="Click to edit">{{$category_list}}</p>
                                        @else
                                        <p data-toggle="tooltip" data-placement="top" title="Click to edit">--</p>
                                        @endif
                                    @endforeach
                        ...
                        @include('service-type.modal.product-category.product_list_edit_modal')
                    </div>
                </div>
                ...
                <div class="card mb-2">
                    <div class="card-body">
                        <div class="row">
                            <div class="col-4">
                                <p>Expected word count per product category/collection page</p>
                            </div>
                            <div class="col-8">
                                <div id="word_count_container">
                                    @if($sales_product_category != null)
                                        <p>{{$sales_product_category->word_count}}</p>
                                    @else
                                        @if($product_category->word_count ?? null)
                                            <button id="word_count_btn" type="button" style="background-color: #ffffff" onclick="toggleWordCountButton()" data-toggle="tooltip" data-placement="top" title="Click to edit">{{$product_category->word_count}}</button>
                                        @else
                                ...
                                <div id="word_count_form">
                                    @if($product_category->word_count)
                                    <form action="" method="post">
                                        @csrf
                                        <div class="input-group" id="input_word_count" style="display: none; margin-top: -10px;">
                                            <input type="text" id="word_count" value="{{$product_category->word_count}}" name="word_count" class="form-control height-35 f-14" aria-label="Recipient's username" aria-describedby="saveButton" placeholder="Input the no. of products here!">
                                            <div class="input-group-append">
                                                <button class="btn btn-outline-secondary saveWordCountBtn" type="button" id="saveButton" data-id="{{$product_category->id}}"><i class="fa-solid fa-check"></i></button>
                                            </div>
                                        </div>
    ...
    @endif
    @if ($sales_product_category !=null && $sales_product_category->status == 'submitted')
...
<script>
    ...
    $(document).ready(function() {
            ...
            $.ajax({
                url: '/projects/update-product-category/'+id,
                method: 'put',
                data: data,
                dataType: "json",
...
<script>
    $(document).ready(function() {
        $('#pm_product_category_submit').click(function(event) {
            event.preventDefault();
            $('#pm_product_category_submit').attr("disabled", true);
            $('#pm_product_category_submit').html("Processing...");
            ...
            var category_url = document.getElementsByName("category_url_2[]");
            var category_url_values = [];
            for (var i = 0; i < category_url.length; i++) {
                category_url_values.push(category_url[i].value);
            }
            var category_list = document.getElementsByName("category_list_2[]");
            ...
            var data= {
                ...
                'sales_product_category_id': document.getElementById("sales_product_category_id").value,
        ...
        $.ajax({
            url: "{{route('pm_product_category_update')}}",
            method: 'post',
            data: data,
            dataType: "json",
            success: function (response) {
                toastr.success('Updated Successfully');
                $(location).prop('href', '{{route('viewProductCategoryCollection',$product_category->deal_id)}}');
                $('#pm_product_category_submit').attr("disabled", false);
                $('#pm_product_category_submit').html("Submit");
            },
            error: function(error) {
                // console.log(response);
                $('#pm_product_category_submit').attr("disabled", false);
...
<script>
    ...
    $(document).ready(function () {
        ...
        function addNewField() {
            var total = $('input[name="category_url_2[]"]').length;
            count = totalFields() + 1;
    ...
    $(document).ready(function () {
        ...
        function addNewField() {
            var total = $('input[name="category_list_2[]"]').length;
            count = totalFields() + 1;
