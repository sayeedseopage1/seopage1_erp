...
$productDescription = \App\Models\ProductDescription::where('id',$product_description->id)->first();
@endphp
                    ...
                    <div class="card mb-5 mt-3" style="border: none">
                        ...
                        <div class="card-body">
                            <form action="" method="post" id="pm_form">
                                ...
                                @if ($productDescription !=null && $productDescription->submitted_by ==4)
                                    <div class="row mb-3">
                                        <div class="col-md-4">
                                        ...
                                        <div class="col-md-8">
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <input type="url" name="website_link_2" id="website_link_2" value="{{ $productDescription->website_link }}" class="form-control placeholderText height-35 f-14" placeholder="https://asdasd.com or https://www.asdasd.com">
                                                </div>
                                                <div class="col-md-6">
                                                    <input type="text" name="website_niche_2" id="website_niche_2" value="{{ $productDescription->website_niche }}" class="form-control placeholderText height-35 f-14" placeholder="Write Your Niche (Pet Care, Digital Marketing)">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-md-8">
                                            <input type="text" name="website_name" id="website_name_2" value="{{ $productDescription->website_name }}" class="form-control placeholderText height-35 f-14" placeholder="Type Your Business/Website Name">
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-4">
                                        ...
                                        <div class="col-md-8">
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        <textarea name="business_information" id="business_information_2" cols="3" rows="3" class="form-control placeholderText" placeholder="Put some details about your company here!">{!! $productDescription->business_information !!}</textarea>
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="mt-2 d-flex">
                                                            <div class="form-check">
                                                                <input class="form-check-input" type="radio" name="share_file_info" value="1" id="share_file_yesBtn" {{ ($productDescription->share_file_info=="1")? "checked" : "" }}>
                                                                <label class="form-check-label mt-1 ml-1" for="share_file_yesBtn">
                                                                    Yes
                                                                </label>
                                                            </div>
                                                            <div class="form-check" style="margin-left: 10px;">
                                                                <input class="form-check-input" type="radio" name="share_file_info" value="0" id="share_file_noBtn" {{ ($productDescription->share_file_info=="0")? "checked" : "" }}>
                                            ...
                                            @if ($productDescription!=null && $productDescription->share_file_info==1)

                                                @php
                                                    if (is_string($productDescription->folder_link) && is_array(json_decode($productDescription->folder_link, true))) {
                                                        $array = json_decode($productDescription->folder_link, true);
                                                        $folder_links = implode(', ', $array);
                                                    }
                                                    $folder_links_array = explode(', ', $folder_links);
                                                @endphp
                                    ...
                                    @php
                                        ...
                                        if ($productDescription->blog_url !== null && is_string($productDescription->blog_url)) {
                                            $array = json_decode($productDescription->blog_url, true);
                                    ...
                                    <div class="row mt-3">
                                        ...
                                        <div class="col-md-8">
                                            <input type="text" name="product_no_2" id="product_no_2" value="{{ $productDescription->product_no }}" class="form-control placeholderText height-35 f-14" placeholder="Input the no. of products here!">
                                        </div>
                                    </div>
                                    <!--Product list-->
                                    @php
                                        ...
                                        if ($productDescription->product_list !== null && is_string($productDescription->product_list)) {
                                            $array = json_decode($productDescription->product_list, true);
                                    ...
                                    <div class="row mt-3">
                                        ...
                                        <div class="col-md-8">
                                            <input type="text" name="word_count_2" id="word_count_2" value="{{ $productDescription->word_count }}" class="form-control placeholderText height-35 f-14" placeholder="Input word count here">
                                        </div>
                                    </div>
                                    <br>
                                    <div class="row">
    ...
    $(document).ready(function() {
        $('#pm_product_description_submit').click(function(event) {
            ...
            var data= {
                ...
                @if ($productDescription !=null && $productDescription->submitted_by ==4)
                    'submitted_by': {{ $productDescription->submitted_by }},
                @endif
