...
<div class="modal fade" id="business_information_edit_modal" tabindex="-1" aria-labelledby="pageListEditModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
      <div class="modal-content">
        ...
        <div class="modal-footer">
          <button type="button" class="btn btn-primary business_information_save" data-id="{{$product_description->id}}">Save changes</button>
        </div>
    </form>
      </div>
    </div>
  ...
  $(document).ready(function() {
    $('.business_information_save').click(function(event) {
      ...
      $.ajax({
        url: '/projects/update-sales-product-description-business-info/' + id,
        method: 'put',
        data: data,
        dataType: "json",
