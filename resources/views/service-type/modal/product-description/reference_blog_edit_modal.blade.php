...
<div class="modal fade" id="reference_blog_edit_modal" tabindex="-1" aria-labelledby="pageListEditModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
      <div class="modal-content">
        ...
        <div class="modal-footer">
          <button type="button" class="btn btn-primary reference_blog_save" data-id="{{$product_description->id}}">Save changes</button>
        </div>
    </form>
      </div>
    </div>
  ...
  $(document).ready(function() {
    $('.reference_blog_save').click(function(event) {
      ...
      $.ajax({
        url: '/projects/update-sales-product-description-reference-blog/' + id,
        method: 'put',
        data: data,
        dataType: "json",
