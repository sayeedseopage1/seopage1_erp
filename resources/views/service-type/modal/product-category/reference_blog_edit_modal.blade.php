...
<div class="modal fade" id="reference_blog_edit_modal" tabindex="-1" aria-labelledby="pageListEditModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="pageListEditModalLabel">Reference product descriptions for the tone and style</h5>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-9">
                                <div class="form-group" style="margin-left: 50px;">
                                    <input type="url" id="category_url" class="form-control placeholderText height-35 f-14" placeholder="Enter reference blog url" name="category_url[]"/>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <div class="modal-footer">
          <button type="button" class="btn btn-primary reference_category_save" data-id="{{$product_category->id}}">Save changes</button>
        </div>
    </form>
      </div>
    </div>
  ...
  $(document).ready(function() {
    $('.reference_category_save').click(function(event) {
      ...
      $.ajax({
        url: '/projects/update-sales-product-category-reference-blog/' + id,
        method: 'put',
        data: data,
        dataType: "json",
