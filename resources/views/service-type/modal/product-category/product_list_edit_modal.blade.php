...
<div class="modal fade" id="product_list_edit_modal" tabindex="-1" aria-labelledby="pageListEditModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="pageListEditModalLabel">List of product category/collection pages that need texts:</h5>
            ...
            <form action="" method="post" id="reference_blog_form">
                ...
                <div class="row mt-3">
                  <div class="col-md-10 dynamic-productList" id="dynamic-productList-list-1">
                      <div class="row mb-3">
                          <div class="col-md-3">
                              <h6 class="mt-1">List of product category/collection pages that need texts:</h6>
                          </div>
                          <div class="col-md-9">
                              <div class="form-group" style="margin-left: 50px;">
                                  <input type="text" id="category_list" class="form-control placeholderText height-35 f-14" placeholder="Paste products page link, or google sheet link here" name="category_list[]"/>
                              </div>
                          </div>
                      </div>
                  </div>
        ...
        <div class="modal-footer">
          <button type="button" class="btn btn-primary category_list_save" data-id="{{$product_category->id}}">Save changes</button>
        </div>
    </form>
      </div>
    </div>
  ...
  $(document).ready(function() {
    $('.category_list_save').click(function(event) {
      ...
      $.ajax({
        url: '/projects/update-sales-product-category-product-list/' + id,
        method: 'put',
        data: data,
        dataType: "json",
