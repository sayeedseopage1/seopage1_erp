...
$basicSeo = \App\Models\BasicSeo::where('id',$basic_seo->id)->first();
@endphp
                    ...
                    <div class="card mb-5 mt-3" style="border: none">
                        ...
                        <div class="card-body">
                            <form action="" method="post" id="pm_form">
                                ...
                                @if ($basicSeo !=null && $basicSeo->submitted_by ==4)
                                    <div class="row">
                                        <div class="col-md-4">
                                            <h6>Site Owner's Name:</h6>
                                        </div>
                                        <div class="col-md-8">
                                            <input type="text" name="owner_name2" id="owner_name2" value="{{ $basicSeo->owner_name }}" class="form-control placeholderText height-35 f-14" placeholder="Write site owner's name here">
                                        </div>
                                    </div>
                                    <div class="row mt-3">
                                        <div class="col-md-4">
                                        ...
                                        <div class="col-md-8">
                                            <input type="text" name="business_name2" id="business_name2" value="{{ $basicSeo->business_name }}" class="form-control placeholderText height-35 f-14" placeholder="Type your exact business name">
                                        </div>
                                    </div>
                                    <div class="row mt-3">
                                        <div class="col-md-4">
                                        ...
                                        <div class="col-md-8">
                                            <input type="text" name="business_address2" id="business_address2" value="{{ $basicSeo->business_address }}" class="form-control placeholderText height-35 f-14" placeholder="Type full address of your business">
                                        </div>
                                    </div>
                                    <div class="row mt-3">
                                        <div class="col-md-4">
                                        ...
                                        <div class="col-md-8">
                                            <input type="text" name="phone_number2" id="phone_number2" value="{{ $basicSeo->phone_number }}" class="form-control placeholderText height-35 f-14" placeholder="Type phone number">
                                        </div>
                                    </div>
                                    <div class="row mt-3">
                                        <div class="col-md-4">
                                        ...
                                        <div class="col-md-8">
                                            <input type="text" name="zip_code2" id="zip_code2" value="{{ $basicSeo->zip_code }}" class="form-control placeholderText height-35 f-14" placeholder="Type zip code">
                                        </div>
                                    </div>
                                    <div class="row mt-3">
                                        <div class="col-md-4">
                                        ...
                                        <div class="col-md-8">
                                            <div class="form-group d-flex">
                                                <div class="form-check">
                                                    <input class="form-check-input" type="radio" name="google_search_info" value="1" id="google_search_info_yesBtn1" {{ ($basicSeo->google_search_info=="1")? "checked" : "" }}>
                                                    <label class="form-check-label mt-1 ml-1" for="google_search_info_yesBtn1">
                                                        Yes
                                                    </label>
                                                </div>
                                                <div class="form-check" style="margin-left: 10px;">
                                                    <input class="form-check-input" type="radio" name="google_search_info" value="0" id="google_search_info_noBtn1" {{ ($basicSeo->google_search_info=="0")? "checked" : "" }}>
                                    ...
                                    <div class="row mt-3">
                                        ...
                                        <div class="col-md-8">
                                            <div class="form-group d-flex">
                                                <div class="form-check">
                                                    <input class="form-check-input" type="radio" name="google_analytic_info" value="1" id="google_analytic_info_yes" {{ ($basicSeo->google_analytic_info=="1")? "checked" : "" }}>
                                                    <label class="form-check-label mt-1 ml-1" for="google_analytic_info_yes">
                                                        Yes
                                                    </label>
                                                </div>
                                                <div class="form-check" style="margin-left: 10px;">
                                                    <input class="form-check-input" type="radio" name="google_analytic_info" value="0" id="google_analytic_info_no" {{ ($basicSeo->google_analytic_info=="0")? "checked" : "" }}>
                                    ...
                                    <div class="row mt-3">
                                        ...
                                        <div class="col-md-8">
                                            <div class="form-group d-flex">
                                                <div class="form-check">
                                                    <input class="form-check-input" type="radio" name="google_business_account_info" value="1" id="google_business_account_info_yes" {{ ($basicSeo->google_business_account_info=="1")? "checked" : "" }}>
                                                    <label class="form-check-label mt-1 ml-1" for="google_business_account_info_yes">
                                                        Yes
                                                    </label>
                                                </div>
                                                <div class="form-check" style="margin-left: 10px;">
                                                    <input class="form-check-input" type="radio" name="google_business_account_info" value="0" id="google_business_account_info_no" {{ ($basicSeo->google_business_account_info=="0")? "checked" : "" }}>
                                    ...
                                    <div class="row mt-3">
                                        ...
                                        <div class="col-md-8">
                                            <div class="form-group d-flex">
                                                <div class="form-check">
                                                    <input class="form-check-input" type="radio" name="share_cms_access_info" value="1" id="share_cms_access_info_yes" {{ ($basicSeo->share_cms_access_info=="1")? "checked" : "" }}>
                                                    <label class="form-check-label mt-1 ml-1" for="share_cms_access_info_yes">
                                                        Share Direct Access
                                                    </label>
                                                </div>
                                                <div class="form-check" style="margin-left: 10px;">
                                                    <input class="form-check-input" type="radio" name="share_cms_access_info" value="0" id="share_cms_access_info_no" {{ ($basicSeo->share_cms_access_info=="0")? "checked" : "" }}>
    ...
    $(document).ready(function() {
        $('#pm_basic_seo_submit').click(function(event) {
            ...
            var data= {
                ...
                @if ($basicSeo !=null && $basicSeo->submitted_by ==4)
                    'submitted_by': {{ $basicSeo->submitted_by }},
                @endif
            }
            $.ajaxSetup({
            headers: {
