          ...
          <div class="d-flex justify-content-between action-bar">
            ...
            <div id="table-actions" class="d-flex align-items-center">
                @if ($manageContractTemplatePermission == 'all' || $manageContractTemplatePermission == 'added')
                    <x-forms.link-primary :link="route('contract-template.create')" class="mr-3 openRightModal" icon="plus">
...
@push('scripts')
    ...
    <script>
        ...
        const showTable = () => {
            window.LaravelDataTables["contract-template-table"].draw();
        }
        ...
        $('body').on('click', '.delete-table-row', function() {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    var url = "{{ route('contract-template.destroy', ':id') }}";
