    ...
    <x-filters.filter-box>
        ...
        <x-filters.more-filter-box>
            ...
            <div class="more-filter-items">
                <label class="f-14 text-dark-grey mb-12 text-capitalize" for="usr">@lang('modules.department.title')</label>
        ...
        <div class="d-block d-lg-flex d-md-flex justify-content-between action-bar">
            <div id="table-actions" class="flex-grow-1 align-items-center">
                @if ($addDepartmentPermission == 'all')
                    <x-forms.link-primary :link="route('departments.create')" class="mr-3 openRightModal float-left" icon="plus">
            ...
            <div class="btn-group mt-2 mt-lg-0 mt-md-0 ml-3" role="group" aria-label="Basic example">
                <a href="{{ route('departments.index') }}" class="btn btn-secondary f-14 btn-active" data-toggle="tooltip"
...
@push('scripts')
    ...
    <script>
        ...
        const applyQuickAction = () => {
            var rowdIds = $("#departments-table input:checkbox:checked").map(function() {
                return $(this).val();
            }).get();


            var url = "{{ route('departments.apply_quick_action') }}?row_ids=" + rowdIds;
