    ...
    <div class="modal-content">
        ...
        <div class="row">
          <div class="col-md-6">
            ...
            <label for="exampleFormControlTextarea1">Deliverable Type<span style="color:red;">*</span>
                <svg class="svg-inline--fa fa-question-circle fa-w-16" data-toggle="popover" data-placement="top" data-content="Deliverable Type" data-html="true" data-trigger="hover" aria-hidden="true" focusable="false" data-prefix="fa" data-icon="question-circle" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" data-fa-i2svg="" data-original-title="" title="">
      ...
      <select class="form-control height-35 f-14" name="milestone_id" id="milestone_id">
       ...
       @endforeach
            ...
            <label for="exampleFormControlTextarea1">Delivery Type<span style="color:red;">*</span>
