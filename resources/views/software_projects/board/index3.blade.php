...
<!-- Mirrored from coderthemes.com/hyper/saas/apps-kanban.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 12 Dec 2022 03:06:34 GMT -->
<head>
        <meta charset="utf-8" />
        ...
        <!-- App favicon -->
        <link rel="shortcut icon" href="{{asset('kanban/assets/images/favicon.ico')}}">
        ...
        <div class="wrapper">
            ...
            <div class="leftside-menu">
                ...
                <a href="index.html" class="logo text-center logo-light">
                    <span class="logo-lg">
                        <img src="{{asset('kanban/assets/images/logo.png')}}" alt="" height="16">
                    </span>
                    <span class="logo-sm">
                        <img src="{{asset('kanban/assets/images/logo_sm.png')}}" alt="" height="16">
                    </span>
                </a>
                ...
                <a href="index.html" class="logo text-center logo-dark">
                    <span class="logo-lg">
                        <img src="{{asset('kanban/assets/images/logo-dark.png')}}" alt="" height="16">
                    </span>
                    <span class="logo-sm">
                        <img src="{{asset('kanban/assets/images/logo_sm_dark.png')}}" alt="" height="16">
                    </span>
                </a>
                ...
                <div class="h-100" id="leftside-menu-container" data-simplebar>
                    ...
                    <div class="help-box text-white text-center">
                        ...
                        <img src="{{asset('kanban/assets/images/help-icon.svg" height="90" alt="Helper Icon Image" />
                    ...
                    <div class="navbar-custom">
                        <ul class="list-unstyled topbar-menu float-end mb-0">
                            ...
                            <li class="dropdown notification-list topbar-dropdown">
                                <a class="nav-link dropdown-toggle arrow-none" data-bs-toggle="dropdown" href="#" role="button" aria-haspopup="false" aria-expanded="false">
                                    <img src="{{asset('kanban/assets/images/flags/us.jpg')}}" alt="user-image" class="me-0 me-sm-1" height="12">
                                ...
                                <div class="dropdown-menu dropdown-menu-end dropdown-menu-animated topbar-dropdown-menu">
                                    ...
                                    <a href="javascript:void(0);" class="dropdown-item notify-item">
                                        <img src="{{asset('kanban/assets/images/flags/germany.jpg')}}" alt="user-image" class="me-1" height="12"> <span class="align-middle">German</span>
                                    </a>

                                    <!-- item-->
                                    <a href="javascript:void(0);" class="dropdown-item notify-item">
                                        <img src="{{asset('kanban/assets/images/flags/italy.jpg')}}" alt="user-image" class="me-1" height="12"> <span class="align-middle">Italian</span>
                                    </a>

                                    <!-- item-->
                                    <a href="javascript:void(0);" class="dropdown-item notify-item">
                                        <img src="{{asset('kanban/assets/images/flags/spain.jpg')}}" alt="user-image" class="me-1" height="12"> <span class="align-middle">Spanish</span>
                                    </a>

                                    <!-- item-->
                                    <a href="javascript:void(0);" class="dropdown-item notify-item">
                                        <img src="{{asset('kanban/assets/images/flags/russia.jpg')}}" alt="user-image" class="me-1" height="12"> <span class="align-middle">Russian</span>
                                    </a>
                                                ...
                                                <div class="d-flex align-items-center">
                                                    <div class="flex-shrink-0">
                                                        <div class="notify-icon">
                                                            <img src="{{asset('kanban/assets/images/users/avatar-2.jpg')}}" class="img-fluid rounded-circle" alt="" />
                                                        </div>
                                                    </div>
                                                    <div class="flex-grow-1 text-truncate ms-2">
                                         ...
                                         <a href="javascript:void(0);" class="dropdown-item p-0 notify-item card read-noti shadow-none mb-2">
                                            <div class="card-body">
                                                ...
                                                <div class="d-flex align-items-center">
                                                    <div class="flex-shrink-0">
                                                        <div class="notify-icon">
                                                            <img src="{{asset('kanban/assets/images/users/avatar-4.jpg')}}" class="img-fluid rounded-circle" alt="" />
                                                        </div>
                                                    </div>
                                                    <div class="flex-grow-1 text-truncate ms-2">
                                ...
                                <div class="dropdown-menu dropdown-menu-end dropdown-menu-animated dropdown-lg p-0">
                                    ...
                                    <div class="p-2">
                                        <div class="row g-0">
                                            <div class="col">
                                                <a class="dropdown-icon-item" href="#">
                                                    <img src="{{asset('kanban/assets/images/brands/slack.png')}}" alt="slack">
                                                    <span>Slack</span>
                                                </a>
                                            </div>
                                            <div class="col">
                                                <a class="dropdown-icon-item" href="#">
                                                    <img src="{{asset('kanban/assets/images/brands/github.png')}}" alt="Github">
                                                    <span>GitHub</span>
                                                </a>
                                            </div>
                                            <div class="col">
                                                <a class="dropdown-icon-item" href="#">
                                                    <img src="{{asset('kanban/assets/images/brands/dribbble.png')}}" alt="dribbble">
                                                    <span>Dribbble</span>
                                                </a>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row g-0">
                                            <div class="col">
                                                <a class="dropdown-icon-item" href="#">
                                                    <img src="{{asset('kanban/assets/images/brands/bitbucket.png')}}" alt="bitbucket">
                                                    <span>Bitbucket</span>
                                                </a>
                                            </div>
                                            <div class="col">
                                                <a class="dropdown-icon-item" href="#">
                                                    <img src="{{asset('kanban/assets/images/brands/dropbox.png')}}" alt="dropbox">
                                                    <span>Dropbox</span>
                                                </a>
                                            </div>
                                            <div class="col">
                                                <a class="dropdown-icon-item" href="#">
                                                    <img src="{{asset('kanban/assets/images/brands/g-suite.png')}}" alt="G Suite">
                                                    <span>G Suite</span>
                                                </a>
                                            </div>
                                        </div> <!-- end row-->
                            ...
                            <li class="dropdown notification-list">
                                <a class="nav-link dropdown-toggle nav-user arrow-none me-0" data-bs-toggle="dropdown" href="#" role="button" aria-haspopup="false"
                                    ...
                                    <span class="account-user-avatar">
                                        <img src="{{asset('kanban/assets/images/users/avatar-1.jpg')}}" alt="user-image" class="rounded-circle">
                                    </span>
                                    <span>
                        ...
                        <div class="app-search dropdown d-none d-lg-block">
                            ...
                            <div class="dropdown-menu dropdown-menu-animated dropdown-lg" id="search-dropdown">
                                ...
                                <div class="notification-list">
                                    ...
                                    <a href="javascript:void(0);" class="dropdown-item notify-item">
                                        <div class="d-flex">
                                            <img class="d-flex me-2 rounded-circle" src="{{asset('kanban/assets/images/users/avatar-2.jpg')}}" alt="Generic placeholder image" height="32">
                                            <div class="w-100">
                                    ...
                                    <a href="javascript:void(0);" class="dropdown-item notify-item">
                                        <div class="d-flex">
                                            <img class="d-flex me-2 rounded-circle" src="{{asset('kanban/assets/images/users/avatar-5.jpg')}}" alt="Generic placeholder image" height="32">
                                            <div class="w-100">
                                ...
                                <div class="col-md-4">
                                    <div class="mb-4" id="tooltip-container">
                                        ...
                                        <a href="javascript:void(0);" data-bs-container="#tooltip-container" data-bs-toggle="tooltip" data-bs-placement="top" title="Mat Helme" class="d-inline-block">
                                            <img src="{{asset('kanban/assets/images/users/avatar-6.jpg')}}" class="rounded-circle avatar-xs" alt="friend">
                                        </a>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="tab-content">
                                <div class="tab-pane show active" id="home-b1">
                                    ...
                                    <div class="d-flex mt-2">
                                        <img class="me-3 avatar-sm rounded-circle" src="{{asset('kanban/assets/images/users/avatar-3.jpg')}}" alt="Generic placeholder image">
                                        <div class="w-100">
                                            ...
                                            <div class="d-flex mt-3">
                                                <a class="pe-3" href="#">
                                                    <img src="{{asset('kanban/assets/images/users/avatar-4.jpg')}}" class="avatar-sm rounded-circle" alt="Generic placeholder image">
                                                </a>
                                                <div class="w-100">
                                ...
                                <div class="tab-pane" id="profile-b1">
                                    ...
                                    <div class="card mb-1 shadow-none border">
                                        <div class="p-2">
                                            <div class="row align-items-center">
                                                <div class="col-auto">
                                                    <img src="{{asset('kanban/assets/images/projects/project-1.jpg')}}" class="avatar-sm rounded" alt="file-image" />
                                                </div>
                                                <div class="col ps-0">
