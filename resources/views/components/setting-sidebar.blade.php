    ...
    <ul class="settings-menu" id="settingsMenu">
        ...
        @if (user()->permission('manage_payment_setting') == 'all')
            <x-setting-menu-item :active="$activeMenu" menu="payment_gateway_settings"
                :href="route('payment-gateway-settings.index')" :text="__('app.menu.paymentGatewayCredential')" />
        @endif
        ...
        @if (user()->permission('manage_ticket_setting') == 'all')
        ...
        @if (user()->permission('manage_project_setting') == 'all')
        ...
        @if (user()->permission('manage_attendance_setting') == 'all')
        ...
        @foreach (worksuite_plugins() as $item)
            @if (View::exists(strtolower($item) . '::sections.setting-sidebar'))
                @include(strtolower($item).'::sections.setting-sidebar')
            @endif
        @endforeach

        @if (in_array('admin', user_roles()))
            <x-setting-menu-item :active="$activeMenu" menu="database_backup_settings"
                :href="route('database-backup-settings.index')" :text="__('app.menu.databaseBackupSetting')" />
        @endif
