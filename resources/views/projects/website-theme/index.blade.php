...
@section('content')
    ...
    <div class="content-wrapper">
        <button type="button" class="btn-primary rounded f-14" data-toggle="modal" data-target="#addwebsitethememodal">
...
@push('scripts')
    ...
    <script>
        ...
        var deadLineEndDate = '';
        $('#project-website-theme-table').on('preXhr.dt', function(e, settings, data) {
        ...
        const showTable = () => {
            window.LaravelDataTables["project-website-theme-table"].draw();
        }
    ...
    <script>
        $('body').on('click', '.project-website-theme-modal', function() {
            let id = $(this).data('project-website-theme-id');
            let searchQuery = "?id=" + id;
            let url = "{{ route('edit-website-theme') }}" + searchQuery;
