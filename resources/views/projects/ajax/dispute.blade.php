                ...
                <div class="row p-20">
                    <div class="col-lg-6 col-md-6">
                        <label for="">Clients username on freelancer.com <strong style="color:red;">*</strong>
                          ...
                          <input type="text" class="form-control height-35 f-14" name="client_username" value="{{ $client->user_name }}" id="client_username" placeholder="Clients username on freelancer.com" readonly>
                    ...
                    <div class="col-lg-6 col-md-6">
                        <label for="">Project value (Mention with currency) <strong style="color:red;">*</strong>
                          ...
                          <input type="number" class="form-control height-35 f-14" name="project_value" value="{{ $project->project_budget }}" id="project_value" placeholder="Project value (Mention with currency)" readonly>
