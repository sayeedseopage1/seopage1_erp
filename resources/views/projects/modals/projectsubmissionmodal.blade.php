...
<div class="modal fade" id="ProjectSubmissionModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog d-flex justify-content-center align-items-center modal-xl">
      <div class="modal-content">
        ...
        <?php
        $project_submission = App\Models\ProjectSubmission::select('project_submissions.*', 'project_niches.category_name', 'project_niches.parent_category_id')
        ...
        $project_portfolio = DB::table('project_portfolios')
                  ...
                  ->select('project_portfolios.*',
                   'project_cms.cms_name',
                    'project_website_types.website_type',
                     'project_niches.category_name',
                     )
