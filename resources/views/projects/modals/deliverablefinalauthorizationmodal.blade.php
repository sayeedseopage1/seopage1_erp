...
<div class="modal fade" id="deliverablesfinalauthorizationModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <form class="" action="/projects/send-final-authorization-deliverables/{{$project->id}}" method="get">
        ...
        <div class="modal-body">
            ...
            <h6 class="text-center">Are You Sure You Want to send approval request?</h6>
