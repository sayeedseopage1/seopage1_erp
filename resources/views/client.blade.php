           ...
           <hr>
                          ...
                          <form class="" action="{{route('client-submission')}}" method="post">
                            ...
                            <div class="row">
                              <div class="col-md-6">
                                <div class="mt-3">
                                    ...
                                    <input id="input-state-2" name="client_username" type="text" class="form-control" placeholder="Enter User Name" required>
                              ...
                              <div class="col-md-6">
                                <div class="mt-3">
                                    ...
                                    <input id="input-state-3" name="client_email" type="text" class="form-control" placeholder="Enter Your Email" required>
                            ...
                            <div class="mt-3">
                                ...
                                <input id="input-state-3" name="client_phone" type="text" class="form-control" placeholder="Enter Your Phone number" required>
                            ...
                            <div class="mt-3">
                                <label for="floatingTextarea"><strong>Our working hour is 8 am-5 pm Monday-Friday and 8 am-1 pm on Saturday. We are off on Sunday (We are in the Bangladeshi timezone GMAT+6). You can convert the Bangladeshi timezone to your timezone here: <a target="_blank" href="https://dateful.com/time-zone-converter">https://dateful.com/time-zone-converter</a>. We may not be able to reply outside of our working hours.
                                  Please confirm if you are okay with this? </strong></label>
                              <textarea class="form-control" name="message" id="message" placeholder="Leave a comment here" required></textarea>
