                ...
                <div class="row p-20">
                    ...
                    <div class="col-lg-6">
                        <div class="form-group" required="required">
                            ...
                            <input type="text" class="form-control height-35 f-14 error" placeholder="Enter Project Name" value="" name="client_name" id="client_name" autocomplete="off" aria-invalid="true">
                    ...
                    <div class="col-lg-4 col-md-4">
                        <div class="form-group " required="required">
                            ...
                            <input type="url" class="form-control height-35 f-14" placeholder="Enter Project Link From Freelancer.com" value="" name="project_link" id="project_link" autocomplete="off">
                   ...
                   <!-- BIDDING DELAY TIME START -->
                    ...
                    <div class="col-lg-4 col-md-4">
                        <div class="form-group my-3">
                            ...
                            <input type="url" class="form-control height-35 f-14" placeholder="Enter the link only" value="" name="insight_screenshot" id="insight_screenshot" autocomplete="off">
                    ...
                    <div class="col-lg-4 col-md-4">
                        <div class="form-group my-3">
                            ...
                            <input type="url" class="form-control height-35 f-14" placeholder="Enter the link only" value="" name="bidpage_screenshot" id="bidpage_screenshot" autocomplete="off">
                        </div>
                    </div>
                    <!-- BIDS PAGE END -->
                    <!-- PROJECT PAGE START -->
                    <div class="col-lg-4 col-md-4">
                        <div class="form-group my-3">
                            ...
                            <input type="url" class="form-control height-35 f-14" placeholder="Enter the link only" value="" name="projectpage_screenshot" id="projectpage_screenshot" autocomplete="off">
