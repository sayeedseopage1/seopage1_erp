                              ...
                              @if($deal->project_type !='hourly')
                                  <div class="col-md-3">
                                      <div class="form-group">
                                          ...
                                          <input type="text" name="amount" value="{{$deal->actual_amount + $deal->upsell_actual_amount}}" class="form-control height-35 f-14" id="amount" placeholder="Enter project buget">
