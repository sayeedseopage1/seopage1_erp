...
<div class="sp1_modal" id="dm-dealaddstagemodal">
            ...
            <div class="sp1_modal_body">
                <form id="createDeal">
                            ...
                            <div class="col-md-6">
                                @if($deal->client_name != null)
                                    <div class="mt-3">
                                        ...
                                        <label id="dm_client_name_error" class="text-danger" for="client_name"></label>
                                    </div>
                                @else
                                    <div class="mt-3">
                                        <label for="client_name" class="form-label"><strong>Client Name <span style="color:red;">*<span></strong>
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn-secondary dismiss-modal" data-dismiss-modal="#dm-dealaddstagemodal">Close</button>
...
<script>
    $(document).ready(function(){
        $('#dm-date-format').daterangepicker({
        ...
        $.ajax({
            ...
            error: function(error) {
                if(error.responseJSON.errors.client_name){
                    $('#dm_client_name_error').text(error.responseJSON.errors.client_name);
                }else{
                    $('#dm_client_name_error').text('');
                }
