<div class="modal fade" id="editMilestone{{ $item->id }}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <input type="hidden" id="milestone_id" value="{{$item->id}}">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="title" value="{{$item->milestone_title}}" id="title" class="form-control title height-35 f-14" id="exampleFormControlInput1"  placeholder="Milestone Name">
                        </div>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" id="cost" value="{{$item->cost}}" name="cost" class="form-control cost height-35 f-14" id="exampleFormControlInput1"  placeholder="Milestone Cost">
                        </div>
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input type="text"  readonly value="{{$item->project->deal->original_currency->currency_code}}({{ $item->project->deal->original_currency->currency_symbol}})"  class="form-control cost height-35 f-14" id="exampleFormControlInput1"  placeholder="Milestone Cost">
                        </div>
                    ...
                    <div class="col-md-8 mt-2" id="inputUrl2" style="display: none;">
                        <div class="input-group">
                            ...
                            <div class="input-group-append">
                                <button class="btn btn-outline-secondary" type="button" id="copyButton2" ><i class="fa fa-clone"></i></button>
                            </div>
                        </div>
                    ...
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <textarea  name="summary"  id="summary" class="form-control" rows="3" >{!! $item->summary !!}</textarea>
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-primary milestone_update" disabled>Update Milestone</button>
...
@push('scripts')
    ...
    <script type="text/javascript">
        ...
        function urlGenerate() {
            ...
            var url = 'http://127.0.0.1:8000/deals/service-type/' + encodeURIComponent(selectedValue.toLowerCase().replace(/ /g, '-'))  + '/' + randomID;
