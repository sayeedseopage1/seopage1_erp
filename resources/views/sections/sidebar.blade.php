                    ...
                    <x-menu-item icon="cart-dash-fill" :text="'Web Dev Sales'">
                        ...
                        <div class="accordionItemContent pb-2">
                            ...
                            @else
                                ...
                                <x-sub-menu-item :link="route('all-price-quotations.index')" :text="'Price Quotations'" />
                ...
                <x-menu-item icon="gear" :text="__('app.menu.settings')">
                    ...
                    <div class="accordionItemContent pb-2">
                        ...
                        @if (Auth::user()->role_id == 1)
                            ...
                            <x-sub-menu-item  :link="route('all-platform-accounts.index')" :text="'Platform Accounts'" />
