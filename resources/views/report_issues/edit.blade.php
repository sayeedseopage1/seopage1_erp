        ...
        <div class="ticket-left w-100">
            <x-form id="updateTicket2" method="PUT">
                ...
                <div class="ticket-reply-back flex-row justify-content-start px-lg-4 px-md-4 px-3 py-3 c-inv-btns bg-white border-top-grey border-right-grey d-none"
                    ...
                    @if ($editTicketPermission == 'all' || ($editTicketPermission == 'owned' && $ticket->agent_id == user()->id) || ($editTicketPermission == 'both' && ($ticket->agent_id == user()->id || $ticket->added_by == user()->id)))
                                                    ...
                                                    <optgroup label="{{ mb_ucwords($group->group_name) }}">
                                                        @foreach ($group->enabledAgents as $agent)
                                                            <option @if ($agent->user->id == $ticket->agent_id) selected @endif
                                                                ...
                                                                value="{{ $agent->user->id }}">
                                                                {{ mb_ucwords($agent->user->name) . ' [' . $agent->user->email . ']' }}
                                                            </option>
                                                        @endforeach
                                                    </optgroup>
                                                @endif
                                    ...
                                    @foreach ($fields as $field)
                                            @if ($field->type == 'text' || $field->type == 'password' || $field->type == 'number')
                                                <div class="col-12 px-0 pb-3 ">
                                                    <p class="mb-0 text-lightest f-14 w-30 text-capitalize">{{ $field->label }}</p>
                                                    <p class="mb-0 text-dark-grey f-14 w-70 text-break">{{ $ticket->custom_fields_data['field_'.$field->id] ?? '--' }}</p>
                                                </div>
                                            ...
                                            @elseif($field->type == 'radio')
                                                <div class="col-12 px-0 pb-3 ">
                                                    <p class="mb-0 text-lightest f-14 w-30 text-capitalize">{{ $field->label }}</p>
                                                    <p class="mb-0 text-dark-grey f-14 w-70 text-break">{{ (!is_null($ticket->custom_fields_data['field_' . $field->id]) ? $ticket->custom_fields_data['field_' . $field->id] : '--') }}</p>
                                                </div>
                                            ...
                                            @elseif($field->type == 'select')
                                                <div class="col-12 px-0 pb-3 ">
                                                    <p class="mb-0 text-lightest f-14 w-30 text-capitalize">{{ $field->label }}</p>
                                                    <p class="mb-0 text-dark-grey f-14 w-70 text-break">{{ (!is_null($ticket->custom_fields_data['field_' . $field->id]) && $ticket->custom_fields_data['field_' . $field->id] != '' ? $field->values[$ticket->custom_fields_data['field_' . $field->id]] : '--') }}</p>
                                                </div>
                                            @elseif($field->type == 'date')
                                                <div class="col-12 px-0 pb-3 ">
                                                    <p class="mb-0 text-lightest f-14 w-30 text-capitalize">{{ $field->label }}</p>
                                                    <p class="mb-0 text-dark-grey f-14 w-70 text-break">{{ (!is_null($ticket->custom_fields_data['field_' . $field->id]) && $ticket->custom_fields_data['field_' . $field->id] != '' ? \Carbon\Carbon::parse($ticket->custom_fields_data['field_' . $field->id])->format(global_setting()->date_format) : '--') }}</p>
                                                </div>
                                            @endif
                                    @endforeach
                                @endif
