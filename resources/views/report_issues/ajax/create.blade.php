...
<div class="row">
    ...
    @endif
        <form id="save-ticket-form" method="post" action="{{route('report_issues.store')}}">

          @csrf

            <div class="add-client bg-white rounded">
                <h4 class="mb-0 p-20 f-21 font-weight-normal text-capitalize border-bottom-grey">
                    @lang('Report an Issue')</h4>
                <div class="row p-20">
                            ...
                            <div class="col-md-8 col-lg-8">
                                <x-forms.label class="my-3" fieldRequired="true" fieldId="issue_type" :fieldLabel="__('Type of Issue')">
                                </x-forms.label>
                                <x-forms.input-group>
                                    <select class="form-control select-picker" name="issue_type" id="issue_type"
                                        data-live-search="true" data-size="8">
                                        <option value="">--</option>

                                        <option value="Design Issue">Design Issue</option>
                                        <option value="Functional/Logical Issue">Functional/Logical Issue</option>
                    ...
                    <div class="col-md-12 mt-1">
                        <x-forms.text :fieldLabel="__('Issue Subject')" fieldName="subject" fieldRequired="true" fieldId="subject" />
                    </div>


                    <div class="col-md-12">
                        <div class="form-group my-3">
                            <x-forms.label fieldId="description" :fieldLabel="__('Explain Issue')" fieldRequired="true">
                            </x-forms.label>
