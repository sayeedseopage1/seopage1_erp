                        ...
                        <div class="col-md-6">
                          ...
                          <div class="row">
                            ...
                            @endif
                              ...
                              $myStringData = str_replace(['[', ']', '"'], '', $myString);
                              $data = explode(",", $myStringData);
                            //   dd($data);
                               ...
                               ?>
                                @foreach($data   as $message)
                                    <div class="col-md-12">
                                    <div class="form-group">
                                    <label for="">Message Link <span style="color:red;">*</span></label>
                                        <svg class="svg-inline--fa fa-question-circle fa-w-16" data-toggle="popover" data-placement="top" data-content="Copy client's profile URL from Freelancer.com and paste it here." data-html="true" data-trigger="hover" aria-hidden="true" focusable="false" data-prefix="fa" data-icon="question-circle" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" data-fa-i2svg="" data-original-title="" title="">
                                            <path fill="currentColor" d="M504 256c0 136.997-111.043 248-248 248S8 392.997 8 256C8 119.083 119.043 8 256 8s248 111.083 248 248zM262.655 90c-54.497 0-89.255 22.957-116.549 63.758-3.536 5.286-2.353 12.415 2.715 16.258l34.699 26.31c5.205 3.947 12.621 3.008 16.665-2.122 17.864-22.658 30.113-35.797 57.303-35.797 20.429 0 45.698 13.148 45.698 32.958 0 14.976-12.363 22.667-32.534 33.976C247.128 238.528 216 254.941 216 296v4c0 6.627 5.373 12 12 12h56c6.627 0 12-5.373 12-12v-1.333c0-28.462 83.186-29.647 83.186-106.667 0-58.002-60.165-102-116.531-102zM256 338c-25.365 0-46 20.635-46 46 0 25.364 20.635 46 46 46s46-20.636 46-46c0-25.365-20.635-46-46-46z"></path>
                                        </svg>
                                        <input type="text" name="message_link[]" value="{{ stripslashes(strip_tags($message)) }}" class="form-control height-35 f-14" id="" placeholder="Input here" readonly>
                                    </div>
                                    </div>
                                @endforeach
                            ...
                            <div class="col-md-12">
                              <div class="form-group">
                                  <label for="freelancer_message_link">Message Thread Link</label>
                                  <svg class="svg-inline--fa fa-question-circle fa-w-16" data-toggle="popover" data-placement="top" data-content="Copy the project message thread link from Freelancer.com and paste it in this field." data-html="true" data-trigger="hover" aria-hidden="true" focusable="false" data-prefix="fa" data-icon="question-circle" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" data-fa-i2svg="" data-original-title="" title="">
                                      <path fill="currentColor" d="M504 256c0 136.997-111.043 248-248 248S8 392.997 8 256C8 119.083 119.043 8 256 8s248 111.083 248 248zM262.655 90c-54.497 0-89.255 22.957-116.549 63.758-3.536 5.286-2.353 12.415 2.715 16.258l34.699 26.31c5.205 3.947 12.621 3.008 16.665-2.122 17.864-22.658 30.113-35.797 57.303-35.797 20.429 0 45.698 13.148 45.698 32.958 0 14.976-12.363 22.667-32.534 33.976C247.128 238.528 216 254.941 216 296v4c0 6.627 5.373 12 12 12h56c6.627 0 12-5.373 12-12v-1.333c0-28.462 83.186-29.647 83.186-106.667 0-58.002-60.165-102-116.531-102zM256 338c-25.365 0-46 20.635-46 46 0 25.364 20.635 46 46 46s46-20.636 46-46c0-25.365-20.635-46-46-46z"></path>
                                  </svg>
                                  <div class="col-md-7 dynamic-field" id="dynamic-field-1">
                          ...
                          <div class="row">
                            <div class="col-md-12">
                              <div class="form-group">
                                <label for="description3Text">Elaborate the "WHAT" 3-4 lines here (The client created a new website recently and he now wants to start full suite SEO for his website.). Please share all the necessary information you possible can here. The execution team will work based on this instruction primarily.
                          ...
                          <div class="row">
                            <div class="col-md-12">
                              <div class="form-group">
                                <label for="description5Text">Any particular focus/concern of the client (Ex: 1. The client is very concerned about his websites current rank drop.  2. The client is frustrated about his google ads campaigns not getting enough returns and desperately wants someone to improve this)
                          ...
                          <div class="row">
                            <div class="col-md-12">
                              <div class="form-group">
                                <label for="description8Text">Is there any cross-departmental work involved in this project? (Example: Web development, content writing, graphic design, UI design or anything else which is not part of digital marketing in general)
...
@if($deal->project_type !='hourly')
    <script>
        $('#createDeal').click(function(e){
            ...
            $.ajax({
                type: "POST",
                url: "{{route('dm-store-deal-details')}}",
                data: data,
                dataType: "json",
                success: function (response) {
                    $('.error').html("");
