                      ...
                      <div class="row">
                        <div class="col-md-6">
                          ...
                          <div class="row">
                            <div class="col-md-12">
                              <div class="form-group">
                                <label for="description3Text">Elaborate the "WHAT" in 3-4 lines here (The client created a new website recently, and he now wants to start full-suite SEO for his website). Please share all the necessary information you possibly can. The execution team will work primarily based on this instruction.
