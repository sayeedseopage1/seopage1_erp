                          ...
                          <div class="dropdown float-right">
                              ...
                              <div class="dropdown-menu dropdown-menu-right border-grey rounded b-shadow-4 p-0"
                                  ...
                                  <a class="dropdown-item"
                                      href="/dm-deals/details/edit/{{$contract->deal->id}}">@lang('Edit')</a>
                              </div>
                          </div>
          ...
          <div class="col-md-12">
              <x-cards.data>
                  <div class="row-cols-lg-1">
                      <div class="col">
                          <h4>
                            Elaborate the "WHAT" 3-4 lines here (The client created a new website recently and he now wants to start full suite SEO for his website.). Please share all the necessary information you possible can here. The execution team will work based on this instruction primarily. </h4>
                          <br>
