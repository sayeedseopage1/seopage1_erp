...
<div class="modal fade" id="dealaddmodal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
          ...
          <div class="mt-3" id="timerss">
              ...
              <input type="text" id="date-format2" name="award_time" class="form-control floating-label height-35 f-14 @error('award_time') is-invalid @enderror" placeholder="Select Exact Award Time" >
      ...
      <div class="modal-footer">
        <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
          <button type="submit" class="btn btn-primary"  value="Submit" id="storeWonDealBtn">Create Won Deal</button>
      </div>
        </form>
    </div>
  </div>
  ...
  @push('scripts')
      <script>
          $('#storeWonDealBtn').click(function(e){
              e.preventDefault();
              $('#storeWonDealBtn').attr("disabled", true);
              $('#storeWonDealBtn').html("Processing...");
              var data= {
                  '_token': "{{ csrf_token() }}",
                  ...
                  'award_time': document.getElementById("date-format2").value,
              }
              $.ajaxSetup({
                  headers: {
              ...
              $.ajax({
                  ...
                  success: function (response) {
                      ...
                      $('#storeWonDealBtn').attr("disabled", false);
                      $('#storeWonDealBtn').html("Create Won Deal");
