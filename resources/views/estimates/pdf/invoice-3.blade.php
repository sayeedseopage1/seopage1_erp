...
<div id="container">
    <section id="memo">
        ...
        <div class="company-info">
            <div>
               {{ mb_ucwords(global_setting()->company_name) }}
            </div>
            ...
            <span>{{ global_setting()->company_phone }}</span>
    ...
    <section id="terms">
        <div class="notes">
            <div>
                <span>@lang('modules.estimates.validTill'):</span> <span>{{ $estimate->valid_till ? $estimate->valid_till->format(global_setting()->date_format) : '--' }}</span>
            </div>
            @if($estimate->status == 'unpaid')
            <div>
                <span>@lang('app.dueDate'):</span> <span>{{ $estimate->due_date->format(global_setting()->date_format) }}</span>
            </div>
            @endif
            <div>
