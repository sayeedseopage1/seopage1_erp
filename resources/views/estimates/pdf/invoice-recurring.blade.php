            ...
            <td>
                <div id="company">
                    <div class="logo">
                        ...
                        @else
                            <img src="{{ asset_url('app-logo/' . global_setting()->logo) }}" alt="home" class="dark-logo" />
                        @endif
                    </div>
...
<main>
    <div id="details" class="clearfix">
        ...
        <div id="invoice">
            ...
            @endif
            <div class="date">@lang('app.menu.issues') @lang('app.date'): {{ $invoice->issue_date->format(global_setting()->date_format) }}</div>
            @if($invoice->status === 'unpaid')
                <div class="date">@lang('app.dueDate'): {{ $invoice->due_date->format(global_setting()->date_format) }}</div>
            @endif
