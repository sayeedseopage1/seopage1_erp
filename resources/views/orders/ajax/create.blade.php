                ...
                <div class="form-group mb-lg-0 mb-md-0 mb-4">
                    ...
                    <div class="input-group">
                        <input type="text" id="invoice_date" name="issue_date"
                            ...
                            value="{{ Carbon\Carbon::now(global_setting()->timezone)->format(global_setting()->date_format) }}">
                    </div>
                </div>
            </div>
            <!-- INVOICE DATE END -->
                ...
                <div class="form-group mb-lg-0 mb-md-0 mb-4">
                    ...
                    <div class="input-group ">
                        <input type="text" id="due_date" name="due_date"
                            class="px-6 position-relative text-dark font-weight-normal form-control height-35 rounded p-0 text-left f-15"
                            placeholder="@lang('placeholders.date')"
                            value="{{ Carbon\Carbon::now(global_setting()->timezone)->addDays($invoiceSetting->due_after)->format(global_setting()->date_format) }}">
                    </div>
                </div>
            </div>
            <!-- DUE DATE END -->
                    ...
                    <div class="form-group c-inv-select mb-4">
                        <select class="form-control select-picker" data-live-search="true" data-size="8"
                            ...
                            @foreach ($clients as $clientOpt)
                                <option @if (isset($estimate) && $clientOpt->id == $estimate->client_id) selected @endif data-content="<div class='d-inline-block mr-1'><img class='taskEmployeeImg rounded-circle'
                                    src='{{ $clientOpt->image_url }}'></div> {{ ucfirst($clientOpt->name) }}"
