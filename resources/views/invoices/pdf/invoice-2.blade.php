            ...
            <section id="invoice-info">
                <table>
                    <tr>
                        ...
                        <td>{{ $invoice->issue_date->format(global_setting()->date_format) }}</td>
                    </tr>
                    @if (empty($invoice->order_id) && $invoice->status === 'unpaid' && $invoice->due_date->year > 1)
                        <tr>
                            <td>@lang('app.dueDate'):</td>
                            <td>{{ $invoice->due_date->format(global_setting()->date_format) }}</td>
                        </tr>
                    @endif
                    <tr>
                                    ...
                                    <tbody>
                                        ...
                                        @forelse($payments as $key => $payment)
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                    {{ $payment->paid_on->format(global_setting()->date_format) }}
                                                </td>
                                            </tr>
                                        @empty
                                        @endforelse
