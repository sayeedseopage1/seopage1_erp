        ...
        <x-form id="save-ticket-data-form">
            ...
            <div class="add-client bg-white rounded">
                ...
                <div class="row p-20">
                            ...
                            @if(isset($employee) && !is_null($employee))
                                ...
                                <x-forms.input-group>
                                    <select class="form-control select-picker" name="user_id" id="user_id"
                                        ...
                                        <option  data-content="<div class='d-inline-block mr-1'><img class='taskEmployeeImg rounded-circle' src='{{ $employee->image_url }}' ></div> {{ ucfirst($employee->name) }} {{ (user() && user()->id == $employee->id) ? '<span class="ml-2 badge badge-secondary">' . __('app.itsYou') . '</span>' : '' }}" value="{{ $employee->id }}">{{ mb_ucwords($employee->name) }}
                                        </option>
                                        @endforeach
                                    </select>
                                </x-forms.input-group>
                    ...
                    <div class="col-md-12">
                        <x-forms.text :fieldLabel="__('modules.tickets.ticketSubject')" fieldName="subject" fieldRequired="true" fieldId="subject" />
                    </div>
                            ...
                            <div class="col-md-4">
                                @if ($field->type == 'text')
                                    <x-forms.text fieldId="custom_fields_data[{{ $field->name . '_' . $field->id }}]"
                                        :fieldLabel="mb_ucwords($field->label)"
                                ...
                                @elseif($field->type == 'textarea')
                                    <x-forms.textarea :fieldLabel="mb_ucwords($field->label)"
                                        fieldName="custom_fields_data[{{ $field->name . '_' . $field->id }}]"
                                        fieldId="custom_fields_data[{{ $field->name . '_' . $field->id }}]"
                                        :fieldRequired="($field->required === 'yes') ? true : false"
                                        :fieldPlaceholder="$field->label">
