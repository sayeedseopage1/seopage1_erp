<div class="modal fade" id="average_project_completion_time_for_this_cycle_modal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="exampleModalLabel">Average Project Completion Time For This Cycle</h5>
        ...
        <div class="modal-footer">
            <a href="{{ route('pm-dashboard-explanation') }}#average_project_completion_time_for_this_cycle" target="_blank" class="btn btn-secondary">See Details</a>
        </div>
      </div>
    </div>
  </div>
