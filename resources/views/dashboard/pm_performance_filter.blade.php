...
<div id="monthHtml">
        ...
        <div class="col-md-6">
            <div class="bg-white p-20 rounded b-shadow-4 d-flex justify-content-between align-items-center mb-4 mb-md-0 mb-lg-0">
                <div class="d-block text-capitalize">
                    ...
                    <div class="d-flex flex-wrap">
                        <p class="mb-0 f-21 font-weight-bold text-blue d-grid mr-5">
                            <a href="#" data-toggle="modal" data-target="#totalDelayProjectForthisCycle{{count($no_of_delayed_projects_this_cycle)}}">{{round($delayed_projects_percentage_this_cycle,2)}}% > {{ $pm_core_metrics->current ?? ''}}%</a>
                            <span class="f-12 font-weight-normal text-lightest">
                                @lang('Current')
                        ...
                        <p class="mb-0 f-21 font-weight-bold text-blue d-grid mr-5">
                            <a href="#" data-toggle="modal" data-target="#totalDelayProjectInthisCycle{{count($no_of_delayed_projects)}}">{{round($delayed_projects_percentage_previous_cycle,2)}}% > {{ $pm_core_metrics->current_plus_old_ones ?? ''}}%</a>
                            <span class="f-12 font-weight-normal text-lightest">
    ...
    <div class="d-flex justify-content-center">
        <button type="button" class="btn btn-primary mt-3" id="adminPMViewMore">View More..</button>
    </div>
</div>
<script>
