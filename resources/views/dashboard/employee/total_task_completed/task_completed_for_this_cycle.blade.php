...
<div class="modal fade" id="taskCompletedForThisCycle{{ count($total_tasks_completed_this_cycle_get) }}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-xl">
      <div class="modal-content">
        ...
        <div class="modal-body">
            <table id="taskCompletedForThisCycleCount" class="display" style="width:100%">
                <thead>
                  <tr>
  ...
  <script>
      new DataTable('#taskCompletedForThisCycleCount',{
