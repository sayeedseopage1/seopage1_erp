...
<div class="modal fade" id="taskCompletedInThisCycle{{ count($total_tasks_completed_previous_cycle_get) }}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-xl">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="exampleModalLabel">Task Completed In This Cycle</h5>
          <button type="button" class="close" data-dismiss="modal" aria-label="Close">
            <span aria-hidden="true">&times;</span>
          </button>
        </div>
        <div class="modal-body">
            <table id="taskCompletedInThisCycleCount" class="display" style="width:100%">
                <thead>
                  <tr>
  ...
  <script>
      new DataTable('#taskCompletedInThisCycleCount');
  </script>
