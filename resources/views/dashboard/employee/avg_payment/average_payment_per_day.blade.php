...
<div class="modal fade" id="avgPayment" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-xl">
      <div class="modal-content">
        <div class="modal-header">
          <div class="modal-title" id="exampleModalLabel">
            <h4>Average Payment Per Day: 0 days</h4>
          </div>
        ...
        <div class="modal-body">
            <table id="avgPaymentPerDay" class="display" style="width:100%">
                <thead>
                  <tr>
  ...
  <script>
      new DataTable('#avgPaymentPerDay',{
