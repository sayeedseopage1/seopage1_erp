...
<div class="modal fade" id="monthlyDisputeInCycle{{count($dispute_in_previous_cycle)}}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-xl">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="exampleModalLabel">Disputed: {{ count($dispute_in_previous_cycle) }}</h5>
          <button type="button" class="close" data-dismiss="modal" aria-label="Close">
            <span aria-hidden="true">&times;</span>
          </button>
        </div>
        <div class="modal-body">
            <table id="monthlyDisputeInCycleTable" class="display" style="width:100%">
                <thead>
                    <tr>
                ...
                <tbody>
                    @foreach ($dispute_in_previous_cycle as $item)
                        @php
  ...
  <script>
      new DataTable('#monthlyDisputeInCycleTable',{
