...
<div class="modal fade" id="causedByMe{{count($caused_by_me_for_cycle)}}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-xl">
      <div class="modal-content">
        ...
        <div class="modal-body">
            <table id="causedByMeTable" class="display" style="width:100%">
                <thead>
                    <tr>
