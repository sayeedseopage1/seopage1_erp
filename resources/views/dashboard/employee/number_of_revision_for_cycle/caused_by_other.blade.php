...
<div class="modal fade" id="causedByOther{{count($caused_by_other_for_cycle)}}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  ...
  <script>
      new DataTable('#causedByOtherTable',{
