...
<div class="modal fade" id="disputeForCycle{{count($dispute_for_cycle)}}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-xl">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="exampleModalLabel">Disputed: {{ count($dispute_for_cycle) }}</h5>
          <button type="button" class="close" data-dismiss="modal" aria-label="Close">
            <span aria-hidden="true">&times;</span>
          </button>
        </div>
        <div class="modal-body">
            <table id="disputeTable" class="display" style="width:100%">
                <thead>
                    <tr>
                ...
                <tbody>
                    @foreach ($dispute_for_cycle as $item)
                        @php
                            ...
                            if ($item->status==1) {
                                ...
                                $raised_by = \App\Models\User::where('id',$item->raised_by)->first();
                            }
                        @endphp
                        <tr>
                            ...
                            <td>
                                ...
                                <div class="d-flex align-items-center">
                                    <div class="" style="width: 28px;">
                                        <div style="width: 32px; height: 28px;">
                                            @if ($raised_by->image)
                                                <img src="{{ asset('user-uploads/avatar/'.$raised_by->image) }}" alt="" width="24" height="24" style="width: 28px; height: 28px;" class="rounded-circle">
                                            @else
                                                <img src="{{ asset('img/avatar.png') }}" alt="" width="24" height="24" style="width: 28px; height: 28px;" class="rounded-circle">
                                            @endif
                                        </div>
