...
<div class="modal fade" id="totalCanceledProjectInThisCycle{{ count($cancelled_projects_previous_cycle) }}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-xl">
      <div class="modal-content">
        ...
        <div class="modal-body">
            <table id="cancelled_project_in_this_cycle_table" class="display" style="width:100%">
                <thead>
                  <tr>
  ...
  <script>
      new DataTable('#cancelled_project_in_this_cycle_table');
  </script>
