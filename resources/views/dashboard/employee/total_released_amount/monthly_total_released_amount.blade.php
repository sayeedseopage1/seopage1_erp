...
<div class="modal fade" id="monthlyTotalReleasedAmount{{ count($total_released_amount_previous_cycle_get) }}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <table id="monthly_total_released_amount" class="display" style="width:100%">
                        <thead>
                            <tr>
