...
<div class="modal fade" id="releasedAmountCycle{{ count($total_released_amount_this_cycle_get) }}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-12">
                        <table id="released_amount_cycle" class="display" style="width:100%">
                            <thead>
                                <tr>
