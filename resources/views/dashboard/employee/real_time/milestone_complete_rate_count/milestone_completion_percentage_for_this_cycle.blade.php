...
<div class="modal fade" id="realTimemilestoneComplectionPercentageForThisCycle{{ count($total_milestone_completed_this_cycle) }}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-12">
                        <table id="real_time_milestoneComplectionPercentageForThisCycle" class="display" style="width:100%">
                            <thead>
                              <tr>
  ...
  <script>
    new DataTable('#real_time_milestoneComplectionPercentageForThisCycle',{
