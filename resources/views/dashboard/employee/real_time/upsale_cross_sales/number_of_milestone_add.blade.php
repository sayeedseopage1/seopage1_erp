...
<div class="modal fade" id="realTimenumberOfMilestoneAdd{{ count($no_of_new_milestones_added_on_old_projects) }}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-xl">
      <div class="modal-content">
        ...
        <div class="modal-body">
            <table id="real_time_numberOfMilestoneAddTable" class="display" style="width:100%">
                <thead>
                  <tr>
  ...
  <script>
      new DataTable('#real_time_numberOfMilestoneAddTable',{
