...
<div class="modal fade" id="realTimecausedByMe{{count($caused_by_me_for_cycle)}}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-xl">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="exampleModalLabel">Caused By Me: {{ count($caused_by_me_for_cycle) }}</h5>
          <button type="button" class="close" data-dismiss="modal" aria-label="Close">
            <span aria-hidden="true">&times;</span>
          </button>
        </div>
        <div class="modal-body">
            <table id="real_time_causedByMeTable" class="display" style="width:100%">
                <thead>
                    <tr>
                ...
                <tbody>
                    @foreach ($caused_by_me_for_cycle as $item)
                        @php
  ...
  <script>
      new DataTable('#real_time_causedByMeTable',{
