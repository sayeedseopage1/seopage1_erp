...
<div class="modal fade" id="realTimeaverageComplectionInThisDays{{ count($average_project_completion_rate_previous_cycle) }}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-xl">
      <div class="modal-content">
        ...
        <div class="modal-body">
            <table id="real_time_averageComplectionInThisDayTable" class="display" style="width:100%">
                <thead>
                  <tr>
  ...
  <script>
      new DataTable('#real_time_averageComplectionInThisDayTable',{
