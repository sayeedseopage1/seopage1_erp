...
<div class="modal fade" id="realTimeprogressProjectInThisCycle{{ count($no_of_100_finished_project_previous_cycle) }}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-xl">
      <div class="modal-content">
        ...
        <div class="modal-body">
            <table id="real_time_project_progress_in_this_cycle" class="display" style="width:100%">
                <thead>
                  <tr>
  ...
  <script>
      new DataTable('#real_time_project_progress_in_this_cycle',{
