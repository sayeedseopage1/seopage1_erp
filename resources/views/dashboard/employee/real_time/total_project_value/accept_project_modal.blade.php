...
<div class="modal fade" id="realTimeprojectAcceptValueModal{{ count($no_of_accepted_projects) }}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-12">
                        <table id="real_time_accept_project" class="display" style="width:100%">
                            <thead>
                              <tr>
                            ...
                            <tbody>
                                @foreach ($no_of_accepted_projects as $item)
                                    @php
  ...
  <script>
      new DataTable('#real_time_accept_project',{
