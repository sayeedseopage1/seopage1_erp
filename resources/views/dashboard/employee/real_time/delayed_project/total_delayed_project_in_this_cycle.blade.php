...
<div class="modal fade" id="realTimetotalDelayProjectInthisCycle{{count($no_of_delayed_projects)}}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-xl">
      <div class="modal-content">
        ...
        <div class="modal-body">
            <table id="real_time_delaedProjectTableInCycle" class="display" style="width:100%">
                <thead>
                  <tr>
  ...
  <script>
    new DataTable('#real_time_delaedProjectTableInCycle',{
