...
<div class="modal fade" id="realTimetaskComplectionRateInCycle{{ count($total_tasks_completed_previous_cycle_get) }}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-xl">
      <div class="modal-content">
        ...
        <div class="modal-body">
            <table id="real_time_taskComplectionRateInThisCycle" class="display" style="width:100%">
                <thead>
                  <tr>
  ...
  <script>
      new DataTable('#real_time_taskComplectionRateInThisCycle',{
