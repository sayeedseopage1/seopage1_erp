...
<div class="modal fade" id="realTimetaskComplectionRateForCycle{{ count($total_tasks_completed_this_cycle_get) }}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-xl">
      <div class="modal-content">
        <div class="modal-header">
            <div class="modal-title" id="exampleModalLabel"><h4>{{count($total_tasks_assigned_this_cycle_get)}} tasks assigned</h4>
                <h4>{{count($total_tasks_completed_this_cycle_get)}} tasks completed</h4>
                <h4>Percentage : {{round($tasks_completion_rate_this_cycle,2)}}%</h4>
        ...
        <div class="modal-body">
            <table id="real_time_taskComplectionRateForThisCycle" class="display" style="width:100%">
                <thead>
                  <tr>
                ...
                <tbody>
                    @foreach ($total_tasks_completed_this_cycle_get as $item)
                        @php
  ...
  <script>
      new DataTable('#real_time_taskComplectionRateForThisCycle',{
