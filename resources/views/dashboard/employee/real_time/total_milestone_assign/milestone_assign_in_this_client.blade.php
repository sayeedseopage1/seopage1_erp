...
<div class="modal fade" id="realTimemilestoneAssignInThisClient{{ count($total_milestone_assigned_this_cycle) }}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-12">
                        <table id="real_time_milestoneAssigndInClientTable" class="display" style="width:100%">
                            <thead>
                              <tr>
  ...
  <script>
      new DataTable('#real_time_milestoneAssigndInClientTable',{
