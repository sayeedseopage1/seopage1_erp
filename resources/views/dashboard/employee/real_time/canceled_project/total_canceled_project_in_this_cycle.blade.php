...
<div class="modal fade" id="realTimetotalCanceledProjectInThisCycle{{ count($cancelled_projects_previous_cycle) }}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-xl">
      <div class="modal-content">
        ...
        <div class="modal-body">
            <table id="real_time_cancelled_project_in_this_cycle_table" class="display" style="width:100%">
                <thead>
                  <tr>
                ...
                <tbody>
                    @foreach ($cancelled_projects_previous_cycle as $item)
                        @php
  ...
  <script>
      new DataTable('#real_time_cancelled_project_in_this_cycle_table',{
