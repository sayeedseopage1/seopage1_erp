...
<div class="modal fade" id="taskAssignedForThisCycle{{ count($total_tasks_assigned_this_cycle_get) }}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-xl">
      <div class="modal-content">
        ...
        <div class="modal-body">
            <table id="taskAssignedForThisCycleCount" class="display" style="width:100%">
                <thead>
                  <tr>
  ...
  <script>
      new DataTable('#taskAssignedForThisCycleCount',{
