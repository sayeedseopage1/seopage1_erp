...
<div class="modal fade" id="monthlytaskAssignedForThisCycle{{ count($total_tasks_assigned_this_cycle_get) }}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-xl">
      <div class="modal-content">
        ...
        <div class="modal-body">
            <table id="monthlyTaskAssignedForThisCycleCount" class="display" style="width:100%">
                <thead>
                  <tr>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>{{ $item->heading }}</td>
                        <td>
                            @if($item->independent_task_status == 0)
  ...
  <script>
      new DataTable('#monthlyTaskAssignedForThisCycleCount',{
