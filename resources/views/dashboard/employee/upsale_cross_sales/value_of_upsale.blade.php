...
<div class="modal fade" id="valueOfUpsale{{ count($no_of_new_milestones_added_on_old_projects_value_get) }}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-xl">
      <div class="modal-content">
        ...
        <div class="modal-body">
            <table id="valueOfUpsale" class="display" style="width:100%">
                <thead>
                  <tr>
                ...
                <tbody>
                    @foreach ($no_of_new_milestones_added_on_old_projects_value_get as $item)
                        @php
