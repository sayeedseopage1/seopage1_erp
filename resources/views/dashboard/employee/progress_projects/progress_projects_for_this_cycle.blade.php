...
<div class="modal fade" id="progressProjectForThisCycle{{ count($no_of_100_and_finish_this_cycle) }}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-xl">
      <div class="modal-content">
        ...
        <div class="modal-body">
            <table id="project_progress_for_this_cycle" class="display" style="width:100%">
                <thead>
                  <tr>
  ...
  <script>
      new DataTable('#project_progress_for_this_cycle',{
