...
<div class="modal fade" id="milestoneAssignInThisClient{{ count($total_milestone_assigned_this_cycle) }}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-xl modal-dialog-scrollable">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="exampleModalLabel">Milestone Assignd In This Client</h5>
        ...
        <div class="modal-body">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-12">
                        <table id="milestoneAssigndInClientTable" class="display" style="width:100%">
                            <thead>
                              <tr>
                            ...
                            <tbody>
                                @foreach ($total_milestone_assigned_this_cycle as $item)
                                    @php
  ...
  <script>
      new DataTable('#milestoneAssigndInClientTable');
  </script>
