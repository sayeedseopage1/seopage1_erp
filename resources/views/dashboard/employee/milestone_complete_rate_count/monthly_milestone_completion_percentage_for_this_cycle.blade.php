...
<div class="modal fade" id="monthlyMilestoneComplectionPercentageForThisCycle{{ count($total_milestone_completed_this_cycle) }}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-xl">
      <div class="modal-content">
        <div class="modal-header">
          <div class="modal-title" id="exampleModalLabel"><h4>{{count($total_milestone_assigned_this_cycle)}} milestones assigned</h4>
            <h4>{{count($total_milestone_completed_this_cycle)}} milestones completed</h4>
            <h4>Percentage : {{round($milestone_completion_rate_count_this_cycle,2)}}%</h4>
        ...
        <div class="modal-body">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-12">
                        <table id="monthlyMilestoneComplectionPercentageForThisCycleCount" class="display" style="width:100%">
                            <thead>
                              <tr>
  ...
  <script>
    new DataTable('#monthlyMilestoneComplectionPercentageForThisCycleCount',{
