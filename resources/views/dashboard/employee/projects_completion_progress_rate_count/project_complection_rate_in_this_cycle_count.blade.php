...
<div class="modal fade" id="projectComplectionProgressInThisCycleCount{{ count($no_of_100_and_finish_previous_cycle) }}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-xl">
      <div class="modal-content">
        ...
        <div class="modal-body">
            <table id="projectComplectionProgressInThisCycle" class="display" style="width:100%">
                <thead>
                  <tr>
  ...
  <script>
      new DataTable('#projectComplectionProgressInThisCycle',{
