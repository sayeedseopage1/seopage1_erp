...
<div class="modal fade" id="projectComplectionProgressForThisCycleCount{{ count($no_of_100_and_finish_this_cycle) }}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-xl">
      <div class="modal-content">
        <div class="modal-header">
          <div class="modal-title" id="exampleModalLabel">
            <h4>{{count($no_of_accepted_projects)}} projects assigned</h4>
            <h4>{{count($no_of_100_and_finish_this_cycle)}} projects completed</h4>
        ...
        <div class="modal-body">
            <table id="projectComplectionProgressCount" class="display" style="width:100%">
                <thead>
                  <tr>
  ...
  <script>
      new DataTable('#projectComplectionProgressCount',{
