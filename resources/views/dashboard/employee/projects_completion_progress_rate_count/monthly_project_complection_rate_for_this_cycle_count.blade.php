...
<div class="modal fade" id="monthlyProjectComplectionProgressForThisCycleCount{{ count($no_of_100_and_finish_this_cycle) }}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
