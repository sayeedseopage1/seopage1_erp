...
<div class="modal fade" id="monthlyNewClient{{ count($no_of_new_clients_this_cycle) }}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-xl">
      <div class="modal-content">
        <div class="modal-header">
            <div class="modal-title" id="exampleModalLabel"><h4>New clients in this cycle: {{count($no_of_new_clients_this_cycle)}}</h4>
        ...
        <div class="modal-body">
            <table id="monthlyNewClient" class="display" style="width:100%">
                <thead>
                    <tr>
  ...
  <script>
      new DataTable('#monthlyNewClient',{
