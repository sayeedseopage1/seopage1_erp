...
<div class="modal fade" id="existingClient{{ count($no_of_existing_clients_this_cycle) }}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-xl">
      <div class="modal-content">
        ...
        <div class="modal-body">
            <table id="existingClient" class="display" style="width:100%">
                <thead>
                  <tr>
