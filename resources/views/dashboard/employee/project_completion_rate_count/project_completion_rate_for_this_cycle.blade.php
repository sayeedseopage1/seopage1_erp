...
<div class="modal fade" id="projectComplectionRateForThisCycle{{ count($no_of_finished_projects_this_cycle) }}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-xl">
      <div class="modal-content">
        ...
        <div class="modal-body">
            <table id="project_complection_for_this_cycle" class="display" style="width:100%">
                <thead>
                  <tr>
  ...
  <script>
      new DataTable('#project_complection_for_this_cycle',{
