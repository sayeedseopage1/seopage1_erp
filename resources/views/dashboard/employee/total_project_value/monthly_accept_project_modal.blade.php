...
<div class="modal fade" id="monthlyProjectAcceptValueModal{{ count($no_of_accepted_projects) }}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-12">
                        <table id="monthly_accept_project" class="display" style="width:100%">
                            <thead>
                              <tr>
                                ...
                                <th scope="col">Project Accept Time</th>
