                ...
                <div class="card-body">
                    ...
                    <div id="monthHtml">
                                        ...
                                        <div class="d-flex flex-wrap">
                                            <p class="mb-0 f-21 font-weight-bold text-blue d-grid mr-5">
                                                <a href="#" data-toggle="modal" data-target="#releasedAmountCycle{{ count($total_released_amount_this_cycle_get) }}">
                                                    {{ round($total_released_amount_this_cycle, 2) }}$ ({{ $pm_core_metrics->released_amount_for_cycle ?? '' }}$)
                                                </a>
                            ...
                            <div class="col-md-6">
                                <div class="bg-white p-20 rounded b-shadow-4 d-flex justify-content-between align-items-center mb-4 mb-md-0 mb-lg-0"
                                    ...
                                    <div class="d-block text-capitalize">
                                        ...
                                        <div class="d-flex flex-wrap">
                                            <a href="#" data-toggle="modal" data-target="#valueOfUpsale{{ count($no_of_new_milestones_added_on_old_projects_value_get) }}">
                                                <p class="mb-0 f-21 font-weight-bold text-blue d-grid mr-5">
                                ...
                                <div class="bg-white p-20 rounded b-shadow-4 d-flex justify-content-between align-items-center mb-4 mb-md-0 mb-lg-0">
                                    <div class="d-block text-capitalize">
                                        ...
                                        <div class="d-flex flex-wrap">
                                            ...
                                            <p class="mb-0 f-21 font-weight-bold text-blue d-grid mr-5">
                                                <a href="#" data-toggle="modal" data-target="#causedByOther{{count($caused_by_other_for_cycle)}}" style="color: green">{{ count($caused_by_other_for_cycle) }}</a>
                                                <span class="f-12 font-weight-normal text-lightest">
                        ...
                        <div class="d-flex justify-content-center">
                            <button type="button" class="btn btn-primary mt-3 btn-lg" id="viewMoreBtn" style="padding: 18px; width:15%; font-size:25px;">View More</button>
                        </div>
                    </div>
                </div>
              </div>
