...
<div class="modal fade" id="MonthlytotalDelayProjectInthisCycle{{count($no_of_delayed_projects)}}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-xl">
      <div class="modal-content">
        ...
        <div class="modal-body">
            <table id="delaedProjectTableMonthlyIn" class="display" style="width:100%">
                <thead>
                  <tr>
  ...
  <script>
    new DataTable('#delaedProjectTableMonthlyIn',{
