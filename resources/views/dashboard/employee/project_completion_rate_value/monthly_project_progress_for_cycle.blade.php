...
<div class="modal fade" id="monthlyprojectProgressForCycle{{ count($no_of_finished_projects_this_cycle) }}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-xl">
      <div class="modal-content">
        ...
        <div class="modal-body">
            <table id="monthly_project_complection" class="display" style="width:100%">
                <thead>
                  <tr>
  ...
  <script>
      new DataTable('#monthly_project_complection',{
