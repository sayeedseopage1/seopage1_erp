...
<div class="modal fade" id="milestoneReleasedForThisCyclet{{ count($total_milestone_completed_this_cycle) }}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-xl">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="exampleModalLabel">Molestone Released For This Cycle</h5>
        ...
        <div class="modal-body">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-12">
                        <table id="milestoneReleasedForClientTable" class="display" style="width:100%">
                            <thead>
                              <tr>
  ...
  <script>
      new DataTable('#milestoneReleasedForClientTable',{
