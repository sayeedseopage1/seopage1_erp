...
<div class="modal fade" id="averageComplectionDays{{ count($average_project_completion_rate) }}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-xl">
      <div class="modal-content">
        ...
        <div class="modal-body">
            <table id="averageComplectionDayTable" class="display" style="width:100%">
                <thead>
                  <tr>
  ...
  <script>
      new DataTable('#averageComplectionDayTable');
  </script>
