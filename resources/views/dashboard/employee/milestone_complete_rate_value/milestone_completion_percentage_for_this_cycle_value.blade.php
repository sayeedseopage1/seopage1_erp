...
<div class="modal fade" id="milestoneComplectionPercentageforValue{{ count($total_milestone_completed_this_cycle) }}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-12">
                        <table id="M_C_P_F_This_value_Table" class="display" style="width:100%">
                            <thead>
                              <tr>
  ...
  <script>
      new DataTable('#M_C_P_F_This_value_Table',{
