...
<div class="modal fade" id="no_of_dispute_lost_overall{{count($number_of_dispute_lost_all_data_lead)}}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
            <table id="no_of_dispute_lost_overall_table" class="display" style="width:100%">
                ...
                <tbody>
                    @foreach($number_of_dispute_lost_all_data_lead as $row)
                    <tr>
                        <td>{{$loop->index+1}}</td>
                        <td>
                            {{$row->assign_date}}
