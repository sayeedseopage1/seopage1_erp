...
<div id="no_of_dispute_lost_overall{{ $number_of_dispute_lose_own_overall_lead }}" class="modal fade" tabindex="-1"
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <table id="no_of_dispute_lost_overall_table" class="display" style="width:100%">
                    ...
                    <tbody>
                        @foreach ($number_of_dispute_lose_own_overall_lead_data as $row)
                            <tr>
