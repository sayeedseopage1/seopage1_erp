...
<div class="modal fade" id="percentage_task_estimate_time_missed{{count($estimate_missed_task_data_lead)}}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
