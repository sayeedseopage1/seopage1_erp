...
<div id="percentage_task_estimate_time_missed{{ count($estimate_missed_task_data_lead) }}" class="modal fade"
    tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-xl">
        <div class="modal-content">
            <div class="modal-header">
                <div class="modal-title">
                    <h4>Percentage of Tasks Where Given Estimated Time was Missed With Revisions:
                        {{ $submit_number_of_tasks_in_this_month_lead }}</h4>
