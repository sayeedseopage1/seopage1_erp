...
<div class="modal fade" id="submit_number_of_tasks_in_this_month_lead{{$submit_number_of_tasks_in_this_month_lead}}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
