...
<div class="modal fade" id="avg_task_submission_in_day{{count($average_submit_data_lead)}}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
            <table id="avg_task_submission_in_day_table" class="display" style="width:100%">
                ...
                <tbody>
                    @foreach($average_submit_data_lead as $row)
                    <tr>
                        <td>{{$loop->index+1}}</td>
                        <td>
                            {{$row->assign_date}}
