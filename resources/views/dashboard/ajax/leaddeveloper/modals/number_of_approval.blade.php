...
<div id="number_of_approval{{ count($number_of_approval_data) }}" class="modal fade" tabindex="-1"
    ...
    <div class="modal-dialog modal-xl">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <table id="number_of_approval_table" class="display" style="width:100%">
                    <thead>
                        <tr>
                    ...
                    <tbody>
                        @foreach ($number_of_approval_data as $row)
                            <tr>
...
<script>
    new DataTable('#number_of_approval_table', {
