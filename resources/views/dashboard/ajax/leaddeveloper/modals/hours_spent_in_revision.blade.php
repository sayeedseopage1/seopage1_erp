...
<div class="modal fade" id="hours_spent_in_revision{{count($spent_revision_developer_data_lead)}}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
            <table id="hours_spent_in_revision_table" class="display" style="width:100%">
                ...
                <tbody>
                    @foreach($spent_revision_developer_data_lead as $row)
                    <tr>
                        <td>{{$loop->index+1}}</td>
                        <td>
                            {{$row->assign_date}}
