...
<div class="modal fade" id="num_of_approved_task_attempt_by_client{{count($first_attempt_approve_task_data_client_lead)}}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-xl">
      <div class="modal-content">
        ...
        <div class="modal-body">
            <table id="number_of_approved_task_on_first_attempt_table" class="display" style="width:100%">
                <thead>
                  <tr>
                ...
                <tbody>
                    @foreach($first_attempt_approve_task_data_client_lead as $row)
                    <tr>
                        <td>{{$loop->index+1}}</td>
                        <td>
                            {{$row->assign_date}}
  ...
  {{-- @foreach($first_attempt_approve_task_data_client_lead as $key => $row)
  ...
  <script>
      new DataTable('#number_of_approved_task_on_first_attempt_table',{
