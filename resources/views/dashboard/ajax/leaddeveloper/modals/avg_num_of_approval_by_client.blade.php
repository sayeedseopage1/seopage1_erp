...
<div class="modal fade" id="avg_num_of_approval_by_client{{count($first_attempt_approve_task_data_client_lead)}}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
