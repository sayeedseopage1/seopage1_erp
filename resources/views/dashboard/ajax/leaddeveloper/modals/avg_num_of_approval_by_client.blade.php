...
<div id="avg_num_of_approval_by_client{{ $total_number_of_attempts_needed_for_approval_by_client }}" class="modal fade"
    ...
    <div class="modal-dialog modal-xl">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <table id="avg_num_approve_by_client_table" class="display" style="width:100%">
                    <thead>
                        <tr>
                            ...
                            <th scope="col">No Of Att. Needed For Approval</th>
                    ...
                    <tbody>
                        @foreach ($total_number_of_attempts_needed_for_approval_by_client_data as $row)
                            <tr>
                                ...
                                <td>
                                    {{ $row->taskType?->task_type ?? $row->taskType?->page_type}}
                                </td>
                                <td>
                                ...
                                <td>
                                    {{ $row->only_responsible_revisions_count + 1 }}
                                </td>
...
<script>
    new DataTable('#avg_num_approve_by_client_table', {
