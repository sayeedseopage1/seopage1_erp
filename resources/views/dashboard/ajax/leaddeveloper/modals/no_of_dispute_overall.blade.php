...
<div class="modal fade" id="no_of_dispute_overall{{count($number_of_dispute_filed_all_data_lead)}}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-xl">
      <div class="modal-content">
        ...
        <div class="modal-body">
            <table id="no_of_dispute_overall_table" class="display" style="width:100%">
                <thead>
                  <tr>
                ...
                <tbody>
                    @foreach($number_of_dispute_filed_all_data_lead as $row)
                    <tr>
                        <td>{{$loop->index+1}}</td>
                        <td>
                            {{$row->assign_date}}
  ...
  {{-- @foreach($submit_number_of_tasks_in_this_month_lead_data as $key => $row)
        ...
        <div class="modal-content">
          ...
          <div class="modal-body">
            <table class="table my-3">
              ...
              <tbody>
                @foreach ($submit_number_of_tasks_in_this_month_lead_data as $task_revision)
                @php
                  $rp_client = '';
                  $rp_developer = '';
                  $rp_pm = '';
  ...
  <script>
      new DataTable('#no_of_dispute_overall_table',{
