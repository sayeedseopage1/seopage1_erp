...
<div class="modal fade" id="country_wise_bidding{{count($country_wise_lead_counts)}}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
