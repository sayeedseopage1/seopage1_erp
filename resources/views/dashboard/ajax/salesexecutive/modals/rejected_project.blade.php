...
<div class="modal fade" id="rejected_project{{count($rejected_project_count)}}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-xl">
      <div class="modal-content">
        <div class="modal-header">
          <div class="modal-title">
                <h4>Total Number of Leads: {{count($rejected_project_count)}}</h4>  
        ...
        <div class="modal-body">
            <table id="rejected_project_table" class="display" style="width:100%">
                <thead>
                  <tr>
                    <th scope="col">#</th>
                ...
                <tbody>
                    @foreach($rejected_project_count as $row)
                    @php
  ...
  <script>
      new DataTable('#rejected_project_table',{
