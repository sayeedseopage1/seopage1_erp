    ...
    <div class="col-md-6">
        <div class="bg-white p-20 rounded b-shadow-4 d-flex justify-content-between align-items-center mb-4 mb-md-0 mb-lg-0">
            <div class="d-block text-capitalize">
                ...
                <div class="d-flex flex-wrap">
                    <p class="mb-0 f-21 font-weight-bold text-blue d-grid mr-5">
                        <a href="#"  data-toggle="modal" data-target="#monthlyCurrent{{count($no_of_delayed_projects_this_cycle)}}">{{round($delayed_projects_percentage_this_cycle,2)}}%  (<span class="f-15">Equals or less than</span> {{ $pm_core_metrics->current ?? ''}}%)</a>
                        <span class="f-12 font-weight-normal text-lightest">
                            @lang('Current')
                    ...
                    <p class="mb-0 f-21 font-weight-bold text-blue d-grid mr-5">
                        <a href="#"  data-toggle="modal" data-target="#monthlyCurrect{{count($no_of_delayed_projects)}}">{{round($delayed_projects_percentage_previous_cycle,2)}}% (<span class="f-15">Equals or less than</span> {{ $pm_core_metrics->current_plus_old_ones ?? ''}}%)</a>
                        <span class="f-12 font-weight-normal text-lightest">
        ...
        <div class="bg-white p-20 rounded b-shadow-4 d-flex justify-content-between align-items-center mb-4 mb-md-0 mb-lg-0">
            <div class="d-block text-capitalize">
                ...
                <div class="d-flex flex-wrap">
                    ...
                    <p class="mb-0 f-21 font-weight-bold text-blue d-grid mr-5">
                        <a href="#" data-toggle="modal" data-target="#monthlyCausedByMe{{count($caused_by_me_for_previous_cycle)}}">{{ count($caused_by_me_for_previous_cycle) }} (<span class="f-15">Equals or less than</span> {{ $pm_core_metrics->number_of_revisions_for_cycle ?? ''}})</a>
                        <span class="f-12 font-weight-normal text-lightest">
                            @lang('Caused by me')
    ...
    <div class="col-md-6">
        <div class="bg-white p-20 rounded b-shadow-4 d-flex justify-content-between align-items-center mb-4 mb-md-0 mb-lg-0">
            <div class="d-block text-capitalize">
                ...
                <div class="d-flex flex-wrap">
                    <p class="mb-0 f-21 font-weight-bold text-blue d-grid mr-5">
                        <a href="#" data-toggle="modal" data-target="#monthlyCausedByMeInCycle{{count($caused_by_me_in_previous_cycle)}}">{{ count($caused_by_me_in_previous_cycle) }} (<span class="f-15">Equals or less than</span> {{ $pm_core_metrics->number_of_revisions_in_cycle ?? ''}})</a>
                        <span class="f-12 font-weight-normal text-lightest">
                            @lang('Caused by me')
