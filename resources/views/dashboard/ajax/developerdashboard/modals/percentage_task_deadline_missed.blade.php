...
<div id="deadline_was_missed{{ count($percentage_of_tasks_where_given_estimated_time_was_missed_without_revision_data) }}" class="modal fade" tabindex="-1"
    aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-xl">
        <div class="modal-content">
            <div class="modal-header">
                <div class="modal-title">
                    <h4>Number of submitted tasks: {{ $percentage_of_tasks_where_given_estimated_time_was_missed_without_revision_total_submitted }}</h4>
                    <h4>Number of tasks where deadline was missed: {{ $percentage_of_tasks_where_given_estimated_time_was_missed_without_revision_total_missed }}</h4>
                </div>
