...
<div class="modal fade" id="submit_number_of_tasks_in_this_month{{$submit_number_of_tasks_in_this_month}}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
