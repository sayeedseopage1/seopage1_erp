...
<div id="number_of_task_received_others_pages{{ $number_of_task_others_page_in_this_month }}" class="modal fade" tabindex="-1"
    ...
    <div class="modal-dialog modal-xl">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <table id="number_of_task_received_table" class="display" style="width:100%">
                    <thead>
                        <tr>
                    ...
                    <tbody>
                        @foreach ($number_of_task_others_page_in_this_month_data as $row)
                            <tr>
                                <td>{{ $loop->index + 1 }}</td>
                                <td>
                                    {{ $row->created_at }}
