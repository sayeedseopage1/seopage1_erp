...
<div class="modal fade" id="no_of_dispute_lost_overall{{count($number_of_dispute_filed_all_data)}}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-xl">
      <div class="modal-content">
        <div class="modal-header">
          <div class="modal-title"><h4>No. of disputes lost(Overall): {{$number_of_dispute_lost_all}}</h4>
             </div>
        ...
        <div class="modal-body">
            <table id="table_no_of_dispute_lost_overall" class="display" style="width:100%">
                ...
                <tbody>
                    @foreach($number_of_dispute_filed_all_data as $row)
                    {{-- {{dd($row)}} --}}
                    <tr>
                        <td>{{$loop->index+1}}</td>
