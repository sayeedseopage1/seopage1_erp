        ...
        <div class="modal-content">
            <div class="modal-header">
                <div class="modal-title">
                    <h4>Number of approved tasks on 1st attempt by Lead Developer:
                        {{ $first_attempt_approve_task_in_this_month_count }}</h4>
                    ...
                    <h4>Number of approved tasks on 1st attempt by Lead Developer Others Pages:
