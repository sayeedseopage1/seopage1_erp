...
<div class="modal fade" id="hours_spent_in_revision_modal{{count($spent_revision_developer_data)}}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
            <table id="table_hours_spent_in_revision" class="display" style="width:100%">
                ...
                <tbody>
                    @foreach($spent_revision_developer_data as $row)
                    {{-- {{dd($row)}} --}}
                    <tr>
                        <td>{{$loop->index+1}}</td>
