...
const EvaluationModal = ({ isEvaluationModal, setIsEvaluationModal }) => {
    const tasksArray = [
        ...
        },
        {
            ...
            linkToTheCompletedWork: "https://example.com/product-descriptions",
        ...
        },
        {
            ...
            linkToTheCompletedWork: "https://example.com/login-functionality",
        ...
        },
        {
            ...
            totalHoursTracked: 8,
            linkToTheCompletedWork: "https://example.com/contact-info-update",
            numberOfRevisionsNeeded: 0,
            action: "Approve",
        },
        // {
