...
import TaskReportExportButton from "../components/task-report-page/TaskReportExportButton";

export const RefetchContext = createContext({});

const TaskReport = () => {
    const [getTaskReport, { isLoading, isFetching }] =
    ...
    return (
        <RefetchContext.Provider value={{ refetch, setRefetch }}>
            <FilterContainer>
                ...
                >
                    <div>
                        <TaskReportExportButton filter={filter} />
                    </div>
                    <Button
                        variant="primary"
