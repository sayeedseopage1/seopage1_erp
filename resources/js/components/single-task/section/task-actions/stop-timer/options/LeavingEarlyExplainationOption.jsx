...
const LeavingEarlyExplainationOption = ({id, onChecked, checked}) => { 
    useEffect(() => {
            ...
            </div>
                {
                    checked && (
                            <div className='pl-3 my-3 bg-white'> 
                                <div className='mb-2 font-weight-bold'> Select the time here </div>
                                ...
                                <div className='mt-3'>
                                    <div className='mb-2 font-weight-bold'>Explain the reason why you are leaving early today</div>  
