...
const LeaveExplainationOption = ({id, onChecked, checked}) => { 
    useEffect(() => {
            ...
            </div>
                {
                    checked && (
                            <div className='pl-3 my-3 bg-white'> 
                                <div className='mb-2 font-weight-bold'> Select an approximate time here </div>
                                <div className='d-flex align-items-center' style={{gap: '10px'}}>
                                    <label htmlFor="">
                                        <input type="radio" name='period' value="first half" style={{cursor: 'pointer'}}/> First Half
                                    </label>

                                    <label htmlFor="">
                                        <input type="radio" name='period' value="second half" style={{cursor: 'pointer'}}/> Second Half
                                    </label>
                                </div>
                                <div className="row">
                                ...
                                <div className='mt-3'>
                                    <div className='mb-2 font-weight-bold'>Explain the reason of your leave</div>  
