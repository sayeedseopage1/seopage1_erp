...
import { EvaluationRoundHistoryTableColumns } from "../../../components/Table/EvaluationRoundHistoryColumns";
import { useGetEvaluationHistoryQuery } from "../../../../services/api/EvaluationApiSlice";
import { EvaluationRoundHistoryTableColumnsPM } from "../table/EvaluationRoundHistoryTableColumnsPM";

const EvaluationRoundHistoryModalPM = ({ data }) => {
            ...
            >
                <Card className={styles.revision_card}>
                    ...
                    <Card.Body className={styles.card_body}>
                        <RoundHistoryTable
                            data={roundData}
                            columns={[...EvaluationRoundHistoryTableColumnsPM]}
                            isLoading={isLoading}
...
export default EvaluationRoundHistoryModalPM;
