...
import ActionEvaluationTaskTablePM from "./ActionEvaluationTaskTablePM";

export const EvaluationTaskTableColumnsPM = [
    {
        id: "task_name",
        header: "Task Name",
...

    {
        ...
        cell: ({ row }) => {
            ...
            return <ActionEvaluationTaskTablePM data={data} />;
        },
    },
];
