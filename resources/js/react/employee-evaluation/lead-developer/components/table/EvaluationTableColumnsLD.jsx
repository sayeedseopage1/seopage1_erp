...
import ActionEvaluationTableLD from "./ActionEvaluationTableLD";
import EvaluationRoundHistoryModalLD from "../modal/EvaluationRoundHistoryModalLD";

export const EvaluationTableColumnsLD = [
    {
        id: "user_name",
    ...
    },
    {
        ...
        cell: ({ row }) => {
            const data = row.original;
            return <EvaluationRoundHistoryModalLD data={data} />;
        },
    },
    {
...

    {
        ...
        cell: ({ row }) => {
            ...
            return <ActionEvaluationTableLD data={data} />;
        },
    },
];
