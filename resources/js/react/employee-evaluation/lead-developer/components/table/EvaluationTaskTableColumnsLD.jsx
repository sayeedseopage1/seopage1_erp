...
import EvaluationTaskRevisionModal from "../../../components/modal/EvaluationTaskRevisionModal";
import ActionEvaluationTaskTableLD from "./ActionEvaluationTaskTableLD";

import ActionEvaluationTaskTablePM from "./ActionEvaluationTaskTableLD";

export const EvaluationTaskTableColumnsLD = [
    {
        id: "task_name",
        header: "Task Name",
...

    {
        ...
        cell: ({ row }) => {
            ...
            return <ActionEvaluationTaskTableLD data={data} />;
        },
    },
];
