...
import EvaluationRatingModalPM from "../modal/EvaluationRatingModalLD";
import EvaluationRatingModalLD from "../modal/EvaluationRatingModalLD";
const ActionEvaluationTaskTableLD = ({ data }) => {
...
export default ActionEvaluationTaskTableLD;
