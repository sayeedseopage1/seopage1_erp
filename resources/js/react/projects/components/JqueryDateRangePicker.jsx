...
const JqueryDateRangePicker = ({
            ...
            $(function() {
               ...
               setEndDate(end.format()); 
                ...
                function cb(start, end) {
                    ...
                    .html(start.format('MMM D, YYYY') + ' to ' + end.format('MMM D, YYYY'));
                }
    ...
    return (
        <div id="jqueryDatePicker" className='sp1__jquery_date_picker sp1_tasks_table_page __date-picker sp1_project_task_table sp1_table_tab--dd-toggle' style={{position: 'relative'}}>
            <div className='sp1__jquery_date_btn'>
                <i className="fa-solid fa-calendar-days"></i>
            </div>
            <div className='sp1__jquery_date_text' style={{whiteSpace: 'nowrap'}}></div>
        </div>
    )
}
