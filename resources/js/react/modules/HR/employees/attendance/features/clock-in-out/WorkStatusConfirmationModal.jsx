...
export const WorkStatusConfirmationModal = ({
    ...
    const [showDailySubmissionForm, setShowDailySubmissionForm] =
            ...
            <React.Fragment>
                    ...
                    <div className={styles.work_status_confirmation_modal}>
                        ...
                        <Switch>
                            <Switch.Case condition={!checkIn && !showReminder}>
                                <React.Fragment>
                                    <div className="text-center">
                                        <i
                                            className={`fa-solid fa-cloud-moon-rain ${styles.cloud}`}
                                        ></i>
                                        <ShowClock className={styles.clock} />
                                    </div>
                                    {/* Check In Form */}
                                    <CheckInForm
                                        onCheckIn={handleCheckInButton}
                                        close={close}
                                    />
                                </React.Fragment>
                            </Switch.Case>
                            <Switch.Case condition={showReminder && data}>
                                <Switch.Case
                                    condition={
                                        !data?.hours_log_report
                                            .hours_log_report_status ||
                                        !data?.daily_task_report
                                            .daily_submission_status
                                    }
                                >
                                    <div
                                        className={
                                            styles.work_status_modal_title
                                        }
                                    >
                                    ...
                                    <ul className={styles.work_status_list}>
                                        ...
                                        >
                                            <div>
                                                Your minimum tracked hours
                                                should have been{" "}
                                                <strong>
                                                    {convertTime(
                                                        data?.hours_log_report
                                                            .data
                                                            .target_minimum_log_hours
                                                    )}
                                                </strong>
                                                , and it is{" "}
                                                <strong>
                                ...
                                >
                                    <>
                                        <p className={styles.thank_you_message}>
                                            ...
                                            Thanks for submitting the required
                                            details
                                        </p>
                                        {/* Continue button */}
                                        <Flex
                ...
                <Modal isOpen={showAcknowledgementReminder}>
                    <AcknowledgementReminderModal
                        ...
                        trackedTimeHistory={data?.user_log}
                        lastClockData={data?.last_log_data}
                        incomplete_hours={
                            data?.hours_log_report.data.incomplete_hours
                        }
                        onSubmit={() => {
                            setData((prev) => ({
                                ...prev,
                ...
                <Modal isOpen={showDailySubmissionForm}>
                    <DailyReportSubmissionEnforcer
                        ...
                        reminderDate={
                            data?.daily_task_report?.data?.checking_date
                        }
                        onSubmit={() => {
                            setData((prev) => ({
                                ...prev,
    ...
    return (
        <div className="w-100">
                ...
                <FormGroup className="w-100">
                    ...
                    <Listbox value={location} onChange={setLocation}>
                        <div className={styles.list_container}>
                            <Listbox.Button
                                className={styles.display_selected_list}
                            >
            ...
            <Flex className="mt-3" justifyContent="center">
                ...
                >
                    <i className="fa-solid fa-arrow-right-to-bracket" /> Clock
                    In
                </Button>
