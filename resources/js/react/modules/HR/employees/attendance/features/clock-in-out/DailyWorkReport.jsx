        ...
        try {
            await axios
                ...
                .then((response) => {
                    ...
                    const cookData = {
                        checkInStatus:
                            response.data.data.check_in_check_out
                                .check_in_status,
                        dailyTaskReport:
                            response.data.data.daily_task_report
                                .daily_submission_status,
                        hourLogStatus:
                            response.data.data.hours_log_report
                    ...
                    if (cookData.checkInStatus) {
                        if (_.includes([5, 9, 10], auth.getRoleId())) {
                            if (
                                cookData.dailyTaskReport &&
                                cookData.hourLogStatus
                            ) {
