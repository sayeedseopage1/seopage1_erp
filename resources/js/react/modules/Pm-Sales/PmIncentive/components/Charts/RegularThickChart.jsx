...
const RegularThickChart = ({ chartData }) => {
    ...
    const { series, ratio, incentive_factors } = chartData;
    ...
    const options = {
        ...
        grid: { show: true, strokeDashArray: 3, position: "back" },
        xaxis: {
        ...
        yaxis: {
            ...
            labels: {
                formatter: (val) => `${val}${chartData?.amountType == 1 ? "" : "%"}`,
                style: {
                    fontSize: "10",
                    fontFamily: "Poppins",
                    fontWeight: 500,
        ...
        dataLabels: {
            ...
            formatter: function (val, opts) {
                ...
                // Show label only for the significant point
        ...
        plotOptions: {
            bar: {
                ...
                dataLabels: {
                    ...
                    position: isAllZero ? "top" : chartData?.incentive > 40 ? "center" : "bottom",
                    maxItems: 100,
                    hideOverflowingLabels: true, // Hide overflowing labels
                },
            },
        },
        fill: {
        ...
        <>
            ...
            <div className="chart_header">
                <div className="chart_title">
                    <span>{chartData?.title}</span> {chartData?.id == 6 && (
                        <Popover
                ...
                <button className="chart_button">{chartData?.chartTag}</button>
            </div>
