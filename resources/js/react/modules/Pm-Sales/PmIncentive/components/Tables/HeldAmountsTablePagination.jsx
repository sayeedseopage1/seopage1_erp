...
const HeldAmountsTablePagination = ({ handlePageSizeChange, handlePageChange, tableData, pageSize }) => {
    return (
...
export default HeldAmountsTablePagination;

HeldAmountsTablePagination.propTypes = {
