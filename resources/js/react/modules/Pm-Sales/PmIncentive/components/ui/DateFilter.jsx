                        ...
                        <ul className='sp1_inc_month_wrapper'>
                                ...
                                [...Array(12)].map((_, i) => {
                                    ...
                                    return (
                                        <Dropdown.Item
                                            ...
                                            className={`sp1_inc_month ${dayjs.dayjs(startDate).format('MMM') === m ? 'active' : ''
                                                }`}
                                        >
                                            {m}
                                        </Dropdown.Item>
                                ...
                                [...Array(4)].map((_, i) => {
                                    ...
                                    return (
                                        <Dropdown.Item
                                            ...
                                            className={`sp1_inc_month ${dayjs.dayjs(startDate).format('MMM') === start ? 'active' : ''
                                                }`}
                                        >
                                            Q{i + 1}
                                        </Dropdown.Item>
                            ...
                            {type === 'yearly' && (
                                <Dropdown.Item
                                    ...
                                    className={`sp1_inc_month w-100 ${dayjs.dayjs(startDate).format('MMM') === 'Jan' ? 'active' : ''
                                        }`}
                                >
                                    Full Year
                                </Dropdown.Item>
