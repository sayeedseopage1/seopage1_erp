                                ...
                                <div className="col-9 flex-column px-0">
                                    <div className="d-flex align-items-center justify-content-start w-100">
                                        ...
                                        <ModalInput
                                            ...
                                            className="ml-2 mr-1"
                                            name="lower_limit"
                                            value={[1, 4]?.includes(limit_unit?.id) ? parseInt(lower_limit) : parseFloat(lower_limit)}
                                            pattern={[1, 4]?.includes(limit_unit?.id) ? "\d*" : "\d*(\.\d+)?"}
                                            onChange={handleChange}
                                            placeholder="Write Here"
                                            style={{ width: '100px' }}
                                        />
                                ...
                                <div className="col-9 flex-column px-0">
                                    <div className="d-flex align-items-center justify-content-start">
                                        ...
                                        <ModalInput
                                            ...
                                            className="ml-2 mr-1"
                                            name="upper_limit"
                                            value={[1, 4]?.includes(limit_unit?.id) ? parseInt(upper_limit) : parseFloat(upper_limit)}
                                            pattern={[1, 4]?.includes(limit_unit?.id) ? "\d*" : "\d*(\.\d+)?"}
                                            onChange={handleChange}
                                            placeholder="Write Here"
                                            style={{ width: '100px' }}
                                    ...
                                    <div className="d-flex align-items-center justify-content-start">
                                        ...
                                        <div className="col-6 d-flex align-items-center">
                                            ...
                                            <ModalInput
                                                ...
                                                value={[1, 4]?.includes(limit_unit?.id) ? parseInt(lower_limit_top_range) : parseFloat(lower_limit_top_range)}
                                                pattern={[1, 4]?.includes(limit_unit?.id) ? "\d*" : "\d*(\.\d+)?"}
                                                onChange={handleChange}
                                                placeholder="Write Here"
                                                style={{ width: '100px' }}
                                    ...
                                    <div className="d-flex align-items-center justify-content-start">
                                        <div className="col-6 d-flex align-items-center">
                                            ...
                                            <ModalInput
                                                ...
                                                value={[1, 4]?.includes(limit_unit?.id) ? parseInt(upper_limit_bottom_range) : parseFloat(upper_limit_bottom_range)}
                                                pattern={[1, 4]?.includes(limit_unit?.id) ? "\d*" : "\d*(\.\d+)?"}
                                                onChange={handleChange}
                                                placeholder="Write Here"
                                                style={{ width: '100px' }}
