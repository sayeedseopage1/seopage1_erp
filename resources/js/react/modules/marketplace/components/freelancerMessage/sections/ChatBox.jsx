...
//                                 <EmojiPicker onEmojiClick={onEmojiClick} searchDisabled={true} skinTonesDisabled={true} width={300} height={300} />
//                             </div>
//                         )
//                     }
//                     <div>
...
// TODO: need to fix emoji with text 
...
const ChatBox = () => {
    ...
    const [filePreviews, setFilePreviews] = useState([]);
    const [showEmojiPicker, setShowEmojiPicker] = useState(false);
    const { control, register, handleSubmit, reset, setValue, formState: { errors }, watch } = useForm();
    ...
    const onEmojiClick = (event, emojiObject) => {
        const newMessage = messageInputData + event.emoji;
                ...
                <div className='message_send_actions_wrapper'>
                    {
                        showEmojiPicker && (
                            <div id="emoji_picker" className='mb-2 message_emoji_picker'>
                                <Picker onEmojiClick={onEmojiClick} searchDisabled={true} skinTonesDisabled={true} width={300} height={300} />
                            </div>
                        )
                    }
                    <div>
