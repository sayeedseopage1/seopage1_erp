  ...
  return (
    <> 
      ...
      >
        <div 
          style={{
            justifyContent: column.id === "policy_rules"  ? "center" : 
                            column.id === "applicable_points" ? "end" : 
                            column.id === "department_name" ? "center" : "flex-start",
            paddingRight: column.id === "applicable_points" ? "10px" : "0",
            paddingLeft: column.id === "policy_name" ? "10px" : "0"
          }} 
