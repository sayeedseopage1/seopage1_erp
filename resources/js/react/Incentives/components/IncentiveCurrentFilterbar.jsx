...
import DatePicker from "./IncentiveCurrentFilterDatePicker";
...
const IncentiveCurrentFilterBar = ({ handleDataRequest, type = "monthly" }) => {
    // sidebar
...
export default IncentiveCurrentFilterBar;