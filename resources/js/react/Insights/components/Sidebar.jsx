...
const InsightSidebar = () => {
    ...
    React.useEffect(() => {
        ...
        if (goals?.goals && goals?.goals?.length > 0) {
            ...
            _filteredGoals.past = _goals.filter(
                (goal) => goal.status === "Past"
            );
        }
    ...
    const getMonth = (index, year) => ({
        ...
        start: dayjs()
            ...
            .format("YYYY-MM-DD"),
        duration: function () {
            return `${this.start.format("MMM DD, YYYY")} - ${this.end.format(
                "MMM DD, YYYY"
            )}`;
        },
    });
                    ...
                    <Dropdown.Toggle icon={false}>
                        <Tooltip text="Add New">
                            <Button
                                ...
                                variant="success"
                                className="cnx_ins__sidebar_btn"
                            >
                ...
                <Accordion>
                    <Accordion.Item defaultActive={false}>
                        <div className="cnx_ins__sidebar_dashboards_header">
                            ...
                            >
                                {(active) => (
                                    <div className="cnx_ins__sidebar_dashboards_title">
                                        Dashboards
                                        <i
                                                ...
                                                ?.map((dashboard) =>
                                                    dashboard.dashboard_name ? (
                                                        <div
                                                            ...
                                                            className="cnx_ins__sidebar_item"
                                                        >
                                                            <NavLink
                                                                ...
                                                                className={({
                                                                    ...
                                                                    isActive
                                                                        ? "cnx_ins__sidebar_item_link active"
                                                                        : "cnx_ins__sidebar_item_link"
                                                                }
                                                            >
                                                                <span>
                                                                    <i className="fa-solid fa-chart-pie" />
                    ...
                    <Accordion.Item defaultActive={true}>
                        <div className="cnx_ins__sidebar_dashboards_header">
                            ...
                            <Dropdown className="cnx_ins--goal-filter-dd mr-2">
                                <Dropdown.Toggle
                                    icon={false}
                                    className="cnx_ins--goal-filter-dd-toggle"
                                >
                                    <Button
                                        aria-label="GoalAddButton"
                                        className="cnx_ins__sidebar_dashboards_dd_btn"
                                ...
                                <Dropdown.Menu className="cnx_ins--goal-filter-dd-menu">
                                    ...
                                    <div className="cnx_ins--goal-filter-dd-menu--options">
                                        {[...Array(12)].map((_, i) => (
                                            <Dropdown.Item
                                                key={
                                                    getMonth(i, selectedYear)
                                                        .name
                                                }
                                                onClick={() =>
                                                    handleGoalMonthFilter(
                                                        getMonth(
                                                            i,
                                                            selectedYear
                                                        )
                                ...
                                <Dropdown className="cnx_ins--goal-filter-dd mr-2">
                                    ...
                                    >
                                        <Button
                                            ...
                                            className={
                                                selectedTeam
                                                    ? "cnx_ins__sidebar_dashboards_dd_btn active"
                                                    : "cnx_ins__sidebar_dashboards_dd_btn"
                                            }
                                        >
                            ...
                            >
                                ...
                                >
                                    <NavLink
                                        ...
                                        className={({ isActive }) =>
                                            isActive
                                                ? "cnx_ins__sidebar_item_link __goal_item active"
                                                : "cnx_ins__sidebar_item_link __goal_item"
                                        }
                                    >
                                        <TextHighlighter
                                            searchWords={search}
