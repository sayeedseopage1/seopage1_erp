...
import TimeLogHistory from "./pages/TimeLogHistory";
import ProjectWiseTimeLog from "./pages/ProjectWiseTimeLog";
import ClientWiseDailySubmission from "./pages/ClientWiseDailySubmission";

// const EmployeeWiseTimeLogTable = lazy(() =>
//     import("./pages/EmployeeWiseTimeLogTable")
// );
...
// const ClientWiseDailySubmission = lazy(() =>
//     import("./pages/ClientWiseDailySubmission")
// );
                        ...
                        <BrowserRouter basename="/account/time-log-report">
                            <Routes>
                                <Route path="/" element={<TimeLogTable />}>
                                    ...
                                    />
                                    <Route
                                        path="/daily-submission-client-wise"
                                        element={
                                            <React.Suspense
                                                fallback={<PageLoader />}
                                            >
                                                <ClientWiseDailySubmission />
                                            </React.Suspense>
                                        }
                                    />
                                </Route>
