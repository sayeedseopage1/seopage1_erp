...
const ReportResolvePreviewModal = () => {
                            ...
                            <div className=''>
                                <div>
                                    <p className=''>
                                        ...
                                        <span>I Didn't Have Enough Work to Do</span>
                                    </p>
                                </div> 
                                ...
                                <div className='mt-3'>
                                    ...
                                    <span className='d-block mt-2'>
                                        <strong>Specific Reason:</strong> I Had Half Day of Leave Today
                                    </span>
                                    <div className='sp1_ck_content py-1'>
                                       <strong>Comment:</strong>  I don't have any pending tasks and lead developer did not assigned any task to do today.
                                    </div>
                                </div> 
