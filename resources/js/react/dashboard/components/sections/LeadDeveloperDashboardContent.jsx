...
const LeadDeveloperDashboardContent = ({
    ...
    return (
        <SectionWrapper
            className="sp1_dashboard_lead_developer_content"
            gap="10px"
        ...
        >
            ...
            <SectionWrapper
                gap="10px"
                className="sp1_dashboard_lead_developer_1st_section"
                padding="0px"
            >
                <SectionWrapper
                    className="sp1_dashboard_lead_developer_1st_section_left"
                ...
                <SectionWrapper
                    className="sp1_dashboard_lead_developer_1st_section_right"
                    backgroundColor="transparent"
                    padding="0px"
                    gap="10px"
                    flex="1"
            ...
            <SectionWrapper
                gap="10px"
                className="sp1_dashboard_lead_developer_2nd_section"
                padding="0px"
            >
                <SectionWrapper
                    className="sp1_dashboard_lead_developer_2nd_section_left"
                    backgroundColor="var(--primaryDarkBlue)"
                    padding="0px"
                    flex="1"
                    border="1px solid var(--primaryDarkBorderBlue)"
                >
                    {leadDeveloperDashboardData?.slice(4, 6)?.map((data) => {
                        return (
                            <SectionWrapper
                                key={data?.id}
                                backgroundColor="transparent"
                ...
                <SectionWrapper
                    className="sp1_dashboard_lead_developer_2nd_section_right"
                    backgroundColor="var(--primaryDarkBlue)"
                    padding="0px"
                    gap="10px"
                    flex="1"
                ...
                >
                    ...
                    <SectionWrapper
                        ...
                        className="d-flex"
                    >
                        {leadDeveloperDashboardData?.slice(6, 8).map((data) => (
                            <SectionWrapper
                                key={data?.id}
                                backgroundColor="transparent"
                                flex="1"
            ...
            <SectionWrapper
                gap="10px"
                className="sp1_dashboard_lead_developer_3rd_section"
                padding="0px"
            >
                <SectionWrapper
                    className="sp1_dashboard_lead_developer_3rd_section_left"
                    backgroundColor="var(--primaryDarkBlue)"
                    padding="0px"
                    flex="1"
                    border="1px solid var(--primaryDarkBorderBlue)"
                >
                    {leadDeveloperDashboardData?.slice(8, 10)?.map((data) => {
                        return (
                            <SectionWrapper
                                key={data?.id}
                                backgroundColor="transparent"
                ...
                <SectionWrapper
                    ...
                    border="1px solid var(--primaryDarkBorderBlue)"
                >
                    {leadDeveloperDashboardData?.slice(10, 12)?.map((data) => {
                        return (
                            <SectionWrapper
                                key={data?.id}
                                backgroundColor="transparent"
            ...
            <SectionWrapper
                gap="10px"
                className="sp1_dashboard_lead_developer_4th_section"
                padding="0px"
            >
                <SectionWrapper
                    className="sp1_dashboard_lead_developer_4th_section_left"
                    backgroundColor="var(--primaryDarkBlue)"
                    padding="0px"
                    flex="1"
                    border="1px solid var(--primaryDarkBorderBlue)"
                >
                    {leadDeveloperDashboardData?.slice(12, 15)?.map((data) => {
                        return (
                            <SectionWrapper
                                key={data?.id}
                                backgroundColor="transparent"
                ...
                <SectionWrapper
                    className="sp1_dashboard_lead_developer_4th_section_right"
                    backgroundColor="transparent"
                    padding="0px"
                    flex="1"
                    gap="10px"
...
export default LeadDeveloperDashboardContent;
