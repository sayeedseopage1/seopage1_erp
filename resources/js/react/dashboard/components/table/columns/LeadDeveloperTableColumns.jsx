...
const LeadDeveloperModalTableColumns = [
    {
        id: "id",
        header: "SL",
        cell: ({ row }) => {
    ...
    },
    {
        ...
        cell: ({ row }) => {
            const data = row.original;
            return (
                <span className="singleline-ellipsis" title={data.revision_count}>
                    {data.revision_count}
                </span>
            );
        },
...
LeadDeveloperTableColumns.Modal = LeadDeveloperModalTableColumns;
