 ...
 */
export const useGetLeadDevDashboardModalData = (modalData, filter, userData) => {
    const [leadDevDashboardModalData, setLeadDevDashboardModalData] = useState([]);
    ...
    // const {
    //     data: leadDevDashboardModalResponse,
    //     isLoading: leadDevDashboardModalIsLoading,
    //     isFetching: leadDevDashboardModalIsFetching,
    //     refetch: leadDevDashboardModalRefetch,
    ...
    //      * This effect runs whenever `leadDevDashboardModalResponse?.data` or `isModalDataRetchingOrLoading` changes.
    //      *
    ...
    //      */
    //     if (
    //         leadDevDashboardModalResponse?.data &&
    ...
    //         const formattedData =
    //             formateResponse(
    //                 leadDevDashboardModalResponse?.data[responseKey]
    //             ) || []; 

    //         // Map and format the extra info
    //         const formatExtraInfo = modalExtraInfo?.map((item) => ({
    //             ...item,
    //             value: leadDevDashboardModalResponse?.data[item?.key],
    //         }));

    //         // Update state with the formatted extra info and data
    //         setModalExtraInfo(formatExtraInfo);
    //         setLeadDevDashboardModalData(formattedData);
    //     }
    // }, [leadDevDashboardModalResponse?.data, isModalDataRetchingOrLoading]);

    return {
        leadDevDashboardModalData,
        isModalDataRetchingOrLoading,
        modalExtraInfo,
    };
};
