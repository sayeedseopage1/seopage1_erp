...
import RevisionCalculatorExportButton from "./RevisionCalculatorExportButton";
...
const RevisionCalculator = () => {
    ...
    const [getRevisionCalculatorData, { isFetching }] =
    ...
    const fetchData = async (_startDate, _endDate) => {
        ...
        try {
            let res = await getRevisionCalculatorData(
                `?${queryString}`
            ).unwrap();
            setData(res);
        } catch (err) {
                    ...
                    navbar={
                        ...
                        >
                            <Flex>
                                ...
                                <RevisionCalculatorExportButton
                                    filter={{
                                        startDate,
                                        endDate,
                                    }}
