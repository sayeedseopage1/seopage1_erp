...
export default function ProjectManagerExplanationTableLoader({prevItemLength = 7,tableCol}){
        ...
        <tr key={item} className="sp1_tasks_tr" > 
            ...
            <td className="sp1_tasks_td">
                <div className="d-flex align-items-center">
                  <Placeholder width="30px" height="30px" type="circle" className="mb-0"/>
            ...
            <td className="sp1_tasks_td">
                <Placeholder width="80px" height="24px" className="mb-1"/>
            </td> 
        </tr>
    ))
  )
