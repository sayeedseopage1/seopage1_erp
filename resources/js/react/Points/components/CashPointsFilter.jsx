...
export default function CashPointsFilter({
    ...
    const auth = useAuth();
    const { departments, shift, employees } = useSelector(
        (s) => s.pointPageFilterOption
    );
    ...
    const [
        pointTableData,
        { data: tableData, isLoading: dataFetchingStateIsLoading },
    ...
    React.useEffect(() => {
        ...
        let _shift = shift?.filter(
            (s) => s.department_id === dept.id && s.id !== 1
        )[0];
            ...
            {Number(window?.Laravel?.user?.role_id) === 1 ? (
                <>
                    ...
                    <FilterItem className=" hide">
                        <span className="mr-2">
                            Points gained as:{" "}
                            <span className="font-weight-bold">Individual</span>{" "}
                        </span>
                    </FilterItem>
                                ...
                                <div className="sp1__pp_filter_sidebar_items">
                                    ...
                                    <FilterItem className="hide d-flex align-items-center w-100 border-right-0">
                                        <span className="mr-2 w-100">
                                            Credit/Debit:{" "}
                                            <span className="d-block font-weight-bold border py-2 px-2 w-100">
                                                Point Earned{" "}
                                            </span>{" "}
                                        </span>
                                    </FilterItem>
