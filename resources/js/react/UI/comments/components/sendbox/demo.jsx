...
} from "../../../../services/api/commentsApiSlice";
...
const EditorComponent = ({ setScroll, taskId, setIsLoading, onSubmit }) => {
    ...
    const { refetch } = useGetCommentsQuery(param?.taskId);
    ...
    return (
        <SendboxWrapper>
            ...
            <RightButtonGroup isExpended={isExpended}>
                ...
                <SendButton
                    disabled={isFetching || commentPostingStatus}
                    onClick={handlePostComment}
                >
                    {isFetching || commentPostingStatus ? (
                        <Loader
                            title=""
                            borderRightColor="white"
                            width="28px"
