...
import MentionedCommentForPendingActions from "./MentionedCommentForPendingActions";
...
const EditorComponent = ({ setScroll, taskId, setIsLoading, onSubmit }) => {
    ...
    return (
        <SendboxWrapper>
            <EditorWrapperWithImageAndToolbar>
                {mentionedComment && <MentionedCommentForPendingActions />}
...
export default function SendboxForPendingActions({
    setScroll,
    taskId,
    setIsLoading,
    onSubmit,
