...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('factors', function (Blueprint $table) {
            ...
            $table->text('limit_depend_on_models_and_fields')->nullable()->comment('The limit depend on this model and fields');
            $table->unsignedTinyInteger('point_type')->nullable()->comment('1 = Static, 2 = Percentage');
            $table->decimal('points');
            $table->text('point_depend_on_model')->nullable()->comment('The point depend on this model');
