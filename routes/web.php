...
Route::group(['middleware' => 'auth', 'prefix' => 'account'], function () {
    ...
    Route::put('pending-task-conversations/{conversation_id}', [TaskController::class, 'update_pending_parent_task_conversation_question_by_answer'] )->name('update-pending-task-conversations');
