...
<<<<<<< HEAD
    ...
    /**
     * Retrieve a single page of InsightsQuestionnairesQuestionInstance records
     * from the API.
     ...
     * @return InsightsQuestionnairesQuestionPage Page of
     *                                            InsightsQuestionnairesQuestionInstance
     */
    public function page(array $options = [], $pageSize = Values::NONE, string $pageToken = Values::NONE, $pageNumber = Values::NONE): InsightsQuestionnairesQuestionPage {
        ...
        $params = Values::of([
            'CategoryId' => Serialize::map($options['categoryId'], function($e) { return $e; }),
            'PageToken' => $pageToken,
            'Page' => $pageNumber,
            'PageSize' => $pageSize,
        ]);
    ...
    /**
     * Retrieve a specific page of InsightsQuestionnairesQuestionInstance records
     * from the API.
     * Request is executed immediately
     *
