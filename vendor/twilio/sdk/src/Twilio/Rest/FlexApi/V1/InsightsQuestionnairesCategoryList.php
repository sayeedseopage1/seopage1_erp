...
<<<<<<< HEAD
    ...
    /**
     * Retrieve a single page of InsightsQuestionnairesCategoryInstance records
     * from the API.
     ...
     * @return InsightsQuestionnairesCategoryPage Page of
     *                                            InsightsQuestionnairesCategoryInstance
     */
    public function page(array $options = [], $pageSize = Values::NONE, string $pageToken = Values::NONE, $pageNumber = Values::NONE): InsightsQuestionnairesCategoryPage {
        $options = new Values($options);
    ...
    /**
     * Retrieve a specific page of InsightsQuestionnairesCategoryInstance records
     * from the API.
     * Request is executed immediately
     *
