...
if(file_exists(base_path('Modules/RestAPI/Config/config.php'))){
    return [
        ...
        */
        ...
        'stubs' => [
            'enabled' => true,
            'path' => base_path('Modules/RestAPI/Stubs'),
            'files' => [
                'start' => 'start.php',
            ...
            'replacements' => [
                'start' => ['LOWER_NAME'],
                'routes' => ['LOWER_NAME', 'STUDLY_NAME', 'SNAKE_NAME', 'UPPER_NAME', 'MODULE_NAMESPACE'],
                'json' => ['LOWER_NAME', 'STUDLY_NAME', 'SNAKE_NAME', 'UPPER_NAME', 'MODULE_NAMESPACE'],
                'controller/scaffold' => ['LOWER_NAME', 'STUDLY_NAME', 'SNAKE_NAME', 'UPPER_NAME', 'MODULE'],
                'scaffold/requests/create' => ['LOWER_NAME', 'STUDLY_NAME', 'SNAKE_NAME', 'UPPER_NAME',  'MODULE_NAMESPACE', 'MODULE'],
                'scaffold/requests/index' => ['LOWER_NAME', 'STUDLY_NAME', 'MODULE_NAMESPACE', 'MODULE'],
                'scaffold/requests/update' => ['LOWER_NAME', 'STUDLY_NAME', 'SNAKE_NAME', 'UPPER_NAME',  'MODULE_NAMESPACE', 'MODULE'],
                'scaffold/requests/delete' => ['LOWER_NAME', 'STUDLY_NAME', 'SNAKE_NAME', 'UPPER_NAME',  'MODULE_NAMESPACE', 'MODULE'],
                'scaffold/requests/show' => ['LOWER_NAME', 'STUDLY_NAME', 'SNAKE_NAME', 'UPPER_NAME',  'MODULE_NAMESPACE', 'MODULE'],
                'scaffold/model' => ['LOWER_NAME', 'STUDLY_NAME', 'SNAKE_NAME', 'UPPER_NAME', 'MODULE_NAMESPACE', 'MODULE'],
                'scaffold/observer' => ['LOWER_NAME', 'STUDLY_NAME', 'SNAKE_NAME', 'UPPER_NAME', 'MODULE_NAMESPACE', 'MODULE'],
                'scaffold/factory' => ['LOWER_NAME', 'STUDLY_NAME', 'SNAKE_NAME', 'UPPER_NAME', 'MODULE_NAMESPACE', 'MODULE'],
                'seeder' => ['LOWER_NAME', 'STUDLY_NAME', 'SNAKE_NAME', 'UPPER_NAME', 'MODULE_NAMESPACE', 'MODULE'],
            ],
        ],
        'paths' => [
            /*
