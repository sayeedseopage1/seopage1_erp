...
trait GraphicsDashboard
{
    public function GraphicsDashboard()
    {
        /*if (request('mode') == 'today' && request()->ajax()) {
            ...
            $html = view('dashboard.ajax.graphicsdashboard.today', $this->data)->render();
            ...
            $startMonth = $date->startOfMonth()->subMonths(1)->addDays(20)->toDateString(); 
            ...
            $html = view('dashboard.ajax.graphicsdashboard.month', $this->data)->render();
            ...
            if (request()->ajax()) {
                $html = view('dashboard.ajax.graphicsdashboard', $this->data)->render();
        ...
        if (request('mode') == 'today' && request()->ajax()) {
            ...
            $html = view('dashboard.ajax.graphicsdashboard.general', $this->data)->render();
