...
{
    public function salesDashboardApi()
    {
    ...
    public function salesDashboardCountryWiseBiddingBreakdownApi()
    {
        $validator = Validator::make(request()->all(), [
            'start_date' => 'date',
            'end_date'   => 'date|after:start_date',
        ...
        if ($validator->fails()) {
            ...
            $number_of_leads_receivedClone = $number_of_leads_received;
            ...
            $saleExecutive = [
                ...
                'country_wise_leads_count' => $country_wise_lead_counts->count(),
                'number_of_leads_received' => $number_of_leads_received->count(),
            ];
            return response(['data' => $saleExecutive], 200)->header('Content-Type', 'application/json');
        }
    }

    public function salesDashboardCountryWiseWonDealsApi()
    {
        $validator = Validator::make(request()->all(), [
            'start_date' => 'date',
            'end_date'   => 'date|after:start_date',
