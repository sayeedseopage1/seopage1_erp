...
class WonDealNotification extends Notification
{
    use Queueable;
    protected $deal;
    /**
    ...
    public function toMail($notifiable)
    {
        ...
        $content = '<h4 style="color: #D99218; font-weight: 700; font-size: 22px;">' . __('Deal Details') . ': ' . '</h4>' .
          ...
          ->markdown('mail.won-deal.won_deal', ['url' => $url, 'greet'=> $greet,'content' => $content, 'body'=> $body,'header'=>$header, 'name' => mb_ucwords($notifiable->name)]);
    }
