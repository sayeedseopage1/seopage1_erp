...
class PmUpdateProductCategoryNotification extends Notification
{
    use Queueable;
    protected $task_user;
   ...
   ;
          ...
          ->markdown('mail.service-type.pm_product_category', ['url' => $url, 'greet'=> $greet,'content' => $content, 'body'=> $body,'header'=>$header, 'name' => mb_ucwords($notifiable->name)]);
    }
