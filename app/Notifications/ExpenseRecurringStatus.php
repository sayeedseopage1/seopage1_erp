...
class ExpenseRecurringStatus extends Notification implements ShouldQueue
{
    ...
    public function __construct(ExpenseRecurring $expense)
    {
        ...
        $this->emailSetting = EmailNotificationSetting::where('slug', 'expense-status-changed')->first();
    ...
    public function toMail($notifiable)
    {
        return (new MailMessage)
            ...
            ->action(__('email.expenseRecurringStatus.action'), route('recurring-expenses.show', $this->expense->id))
