...
class QCSubmissionNotification extends Notification
{
    use Queueable;
      protected $milestone;
    ...
    $body= '<p>
      '.'You’ve Received a Project Q&C Submission Request '.$project->project_short_code.'. To check the details, follow this link.'.
   '</p>'
   ;
   $content =
