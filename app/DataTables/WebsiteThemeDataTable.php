    ...
    public function query(ProjectWebsiteTheme $model)
    {
        ...
        if ($request->startDate !== null && $request->endDate !== null) {
            ...
            $model->where(function ($query) use ($startDate, $endDate) {
                $query->whereBetween(DB::raw('DATE(project_website_themes.created_at)'), [$startDate, $endDate]);
                $query->orWhereBetween(DB::raw('DATE(project_website_themes.updated_at)'), [$startDate, $endDate]);
            });
        }
