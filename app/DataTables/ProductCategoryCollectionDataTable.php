...
class ProductCategoryCollectionDataTable extends DataTable
{
    /**
     ...
     *
     * @param \App\Models\ProductCategoryCollection $model
     * @return \Illuminate\Database\Eloquent\Builder
     */
    public function query(ProductCategoryCollection $model)
    {
        $request = $this->request();
        $productCategories = $request->productCategories;

        return $model->newQuery()
            ->whereIn('id', call_user_func_array('array_merge', $productCategories));
    }
          ...
          //->dom($this->domHtml)
            ...
            ->parameters([
                'initComplete' => 'function () {
                   window.LaravelDataTables["product-category-table"].buttons().container()
    ...
    {
        return 'ProductCategoryCollection_' . date('YmdHis');
    }
}
