...
class BasicSeoDataTable extends DataTable
{
    /**
     ...
     *
     * @param \App\Models\BasicSeo $model
     * @return \Illuminate\Database\Eloquent\Builder
     */
    public function query(BasicSeo $model)
    {
        $request = $this->request();
        $basicSeo = $request->basicSeo;

        return $model->newQuery()
            ->whereIn('id', call_user_func_array('array_merge', $basicSeo));
    }
          ...
          //->dom($this->domHtml)
            ...
            ->parameters([
                'initComplete' => 'function () {
                   window.LaravelDataTables["basic-seo-table"].buttons().container()
