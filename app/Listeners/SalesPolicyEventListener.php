        ...
        foreach ($users as $key => $user) {
            ...
            $button = [
                [
                    ...
                    'button_color' => 'primary',
                    'button_type' => 'redirect_url',
                    'button_url' => route('dealDetails', $deal->id),
                ],
            ];
            $action->button = json_encode($button);
            $action->save();
            ...
            // notify user
            Notification::send($user, new SalesPolicyNotification('pending_large_from_submission',  $messageData, route('dealDetails', $deal->id)));
        }
    }
