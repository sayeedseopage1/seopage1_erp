...
class RevisionCalculatorController extends AccountBaseController
{
        ...
        if ($startDate && $endDate) {
            ...
            foreach($users as $pm)
            {
               ...
               // dd($total_tasks);
                ...
                ->where('task_revisions.revision_ackmowledgement','!=',null)
                ->whereBetween('task_revisions.created_at', [$startDate, $endDate])
                ->count();
    ...
    public function SalesIssue(Request $request, $id)
    {
        ...
        if ($startDate && $endDate) { 
            ...
            'lead_developer.id as lead_developer_id','lead_developer.name as lead_developer_name','dispute_raised_by.id as dispute_rasied_by_id','dispute_raised_by.name as dispute_raised_by_name','dispute_raised_against.id as dispute_rasied_agaisnt_id',
            'dispute_raised_against.name as dispute_rasied_against_name',
