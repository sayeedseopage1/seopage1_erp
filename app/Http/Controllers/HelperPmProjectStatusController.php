...
class HelperPmProjectStatusController extends AccountBaseController
{
    public function ProjectPmGoalCreation($pmGoalSetting,$findDeal, $findProject){
        ...
        if($pmGoalSetting->name == 'Regular'){
            ...
            $p_pm_regular_goal->goal_start_date = $pm_project->project_award_time_platform;
            $p_pm_regular_goal->goal_end_date = Carbon::parse($pm_project->project_award_time_platform)->addDay(3);
            ...
            $p_pm_regular_goal->goal_start_date = $pm_project->project_award_time_platform;
            $p_pm_regular_goal->goal_end_date = Carbon::parse($pm_project->project_award_time_platform)->addDay(7);
            ...
            $p_pm_regular_goal->goal_start_date = $pm_project->project_award_time_platform;
            $p_pm_regular_goal->goal_end_date = Carbon::parse($pm_project->project_award_time_platform)->addDay(12);
            ...
            if($milestone_count > 1)
            {
                ...
                $p_pm_regular_goal->goal_start_date = $pm_project->project_award_time_platform;
                $p_pm_regular_goal->goal_end_date = Carbon::parse($pm_project->project_award_time_platform)->addDay(15);
            ...
            if($milestone_count > 2)
            {
                ...
                $p_pm_regular_goal->goal_start_date = $pm_project->project_award_time_platform;
                $p_pm_regular_goal->goal_end_date = Carbon::parse($pm_project->project_award_time_platform)->addDay(22);
            ...
            $p_pm_regular_goal->goal_start_date = $pm_project->project_award_time_platform;
            $p_pm_regular_goal->goal_end_date = Carbon::parse($pm_project->project_award_time_platform)->addDay(29);
            ...
            $pPmPriorityGoal->goal_start_date = $pm_project->project_award_time_platform;
            $pPmPriorityGoal->goal_end_date = Carbon::parse($pm_project->project_award_time_platform)->addDay(3);
            ...
            $pPmPriorityGoal->goal_start_date = $pm_project->project_award_time_platform;
            $pPmPriorityGoal->goal_end_date = Carbon::parse($pm_project->project_award_time_platform)->addDay(4);
            ...
            $pPmPriorityGoal->goal_start_date = $pm_project->project_award_time_platform;
            $pPmPriorityGoal->goal_end_date = Carbon::parse($pm_project->project_award_time_platform)->addDay(7);
            ...
            if($milestone_count > 1)
            {
                ...
                $pPmPriorityGoal->goal_start_date = $pm_project->project_award_time_platform;
                $pPmPriorityGoal->goal_end_date = Carbon::parse($pm_project->project_award_time_platform)->addDay(12);
            ...
            if($milestone_count > 2)
            {
                ...
                $pPmPriorityGoal->goal_start_date = $pm_project->project_award_time_platform;
                $pPmPriorityGoal->goal_end_date = Carbon::parse($pm_project->project_award_time_platform)->addDay(15);
            ...
            if($milestone_count > 3)
            {
                ...
                $pPmPriorityGoal->goal_start_date = $pm_project->project_award_time_platform;
                $pPmPriorityGoal->goal_end_date = Carbon::parse($pm_project->project_award_time_platform)->addDay(22);
            ...
            $pPmHPGoal->goal_start_date = $pm_project->project_award_time_platform;
            $pPmHPGoal->goal_end_date = Carbon::parse($pm_project->project_award_time_platform)->addDay(3);
            ...
            $pPmHPGoal->goal_start_date = $pm_project->project_award_time_platform;
            $pPmHPGoal->goal_end_date = Carbon::parse($pm_project->project_award_time_platform)->addDay(4);
            ...
            $pPmHPGoal->goal_start_date = $pm_project->project_award_time_platform;
            $pPmHPGoal->goal_end_date = Carbon::parse($pm_project->project_award_time_platform)->addDay(7);
            ...
            if($milestone_count > 1)
            {
                ...
                $pPmHPGoal->goal_start_date = $pm_project->project_award_time_platform;
                $pPmHPGoal->goal_end_date = Carbon::parse($pm_project->project_award_time_platform)->addDay(12);
            ...
            if($milestone_count > 2)
            {
                ...
                $pPmHPGoal->goal_start_date = $pm_project->project_award_time_platform;
                $pPmHPGoal->goal_end_date = Carbon::parse($pm_project->project_award_time_platform)->addDay(15);
            ...
            if($milestone_count > 3)
            {
                ...
                $pPmHPGoal->goal_start_date = $pm_project->project_award_time_platform;
                $pPmHPGoal->goal_end_date = Carbon::parse($pm_project->project_award_time_platform)->addDay(22);
            ...
            $pPmTMPGoal->goal_start_date = $pm_project->project_award_time_platform;
            $pPmTMPGoal->goal_end_date = Carbon::parse($pm_project->project_award_time_platform)->addDay(3);
            ...
            $pPmTMPGoal->goal_start_date = $pm_project->project_award_time_platform;
            $pPmTMPGoal->goal_end_date = Carbon::parse($pm_project->project_award_time_platform)->addDay(4);
            ...
            $pPmTMPGoal->goal_start_date = $pm_project->project_award_time_platform;
            $pPmTMPGoal->goal_end_date = Carbon::parse($pm_project->project_award_time_platform)->addDay(7);
            ...
            if($milestone_count > 1)
            {
                ...
                $pPmTMPGoal->goal_start_date = $pm_project->project_award_time_platform;
                $pPmTMPGoal->goal_end_date = Carbon::parse($pm_project->project_award_time_platform)->addDay(12);
            ...
            if($milestone_count > 2)
            {
                ...
                $pPmTMPGoal->goal_start_date = $pm_project->project_award_time_platform;
                $pPmTMPGoal->goal_end_date = Carbon::parse($pm_project->project_award_time_platform)->addDay(15);
            ...
            $pPmTMPGoal->goal_start_date = $pm_project->project_award_time_platform;
            $pPmTMPGoal->goal_end_date = Carbon::parse($pm_project->project_award_time_platform)->addDay(22);
            ...
            $pPmCSGoal->goal_start_date = $pm_project->project_award_time_platform;
            $pPmCSGoal->goal_end_date = Carbon::parse($pm_project->project_award_time_platform)->addDay(3);
            ...
            $pPmCSGoal->goal_start_date = $pm_project->project_award_time_platform;
            $pPmCSGoal->goal_end_date = Carbon::parse($pm_project->project_award_time_platform)->addDay(4);
            ...
            $pPmCSGoal->goal_start_date = $pm_project->project_award_time_platform;
            $pPmCSGoal->goal_end_date = Carbon::parse($pm_project->project_award_time_platform)->addDay(7);
            ...
            if($milestone_count > 1)
            {
                ...
                $pPmCSGoal->goal_start_date = $pm_project->project_award_time_platform;
                $pPmCSGoal->goal_end_date = Carbon::parse($pm_project->project_award_time_platform)->addDay(12);
            ...
            if($milestone_count > 2)
            {
                ...
                $pPmCSGoal->goal_start_date = $pm_project->project_award_time_platform;
                $pPmCSGoal->goal_end_date = Carbon::parse($pm_project->project_award_time_platform)->addDay(15);
            ...
            if($milestone_count > 3)
            {
                ...
                $pPmCSGoal->goal_start_date = $pm_project->project_award_time_platform;
                $pPmCSGoal->goal_end_date = Carbon::parse($pm_project->project_award_time_platform)->addDay(22);
    ...
    public function HourlyProjectPmGoalCreation($findDeal, $findProject){
        ...
        if($project->status != 'finished'){
            if($findDeal->hourly_rate <=20 ){
                ...
                $p_pm_regular_goal->goal_start_date = $pm_project->project_award_time_platform;
                $p_pm_regular_goal->goal_end_date = Carbon::parse($pm_project->project_award_time_platform)->addHours(30);
                ...
                $p_pm_regular_goal->goal_start_date = $pm_project->project_award_time_platform;
                $p_pm_regular_goal->goal_end_date = Carbon::parse($pm_project->project_award_time_platform)->addHours(60);
                ...
                $p_pm_regular_goal->goal_start_date = $pm_project->project_award_time_platform;
                $p_pm_regular_goal->goal_end_date = Carbon::parse($pm_project->project_award_time_platform)->addDay(5);
