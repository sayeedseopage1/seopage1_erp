...
class KpiDistribution extends Command
{
    ...
    public function handle()
    {
        ...
        //    / dd($kpi);
            ...
            if($find_deal_id->lead_id != null)
            {
                ...
                $point->activity= '<a href="'.route('employees.show',$user_name->id).'">'.$user_name->name . '</a> created the bid Project : <a href="'.route('projects.show',$find_project_id->id).'">'.$find_project_id->project_name. '</a>, Client: <a href="'.route('clients.show',$find_project_id->client_id).'">'. $find_project_id->client_name->name. '</a> (Accpeted By PM('.$kpi->accepted_by_pm.'%))';
                ...
                $point->save();
                    ...
                    $point->project_id= $find_project_id->id;
                    $point->activity= '<a href="'.route('employees.show',$user_name->id).'">'.$user_name->name . '</a> made the deal qualify deal Project : <a href="'.route('projects.show',$find_project_id->id).'">'.$find_project_id->project_name. '</a>, Client: <a href="'.route('clients.show',$find_project_id->client_id).'">'. $find_project_id->client_name->name. '</a> (Accpeted By PM('.$kpi->accepted_by_pm.'%))';
                    $point->gained_as = "Individual";
                    ...
                    $point->project_id= $find_project_id->id;
                    $point->activity= '<a href="'.route('employees.show',$user_name->id).'">'.$user_name->name . '</a> made the deal requirements defined Project : <a href="'.route('projects.show',$find_project_id->id).'">'.$find_project_id->project_name. '</a>, Client: <a href="'.route('clients.show',$find_project_id->client_id).'">'. $find_project_id->client_name->name. '</a> (Accpeted By PM('.$kpi->accepted_by_pm.'%))';
                    $point->gained_as = "Individual";
                    ...
                    $point->project_id= $find_project_id->id;
                    $point->activity= '<a href="'.route('employees.show',$user_name->id).'">'.$user_name->name . '</a> created the proposal Project : <a href="'.route('projects.show',$find_project_id->id).'">'.$find_project_id->project_name. '</a>, Client: <a href="'.route('clients.show',$find_project_id->client_id).'">'. $find_project_id->client_name->name. '</a> (Accpeted By PM('.$kpi->accepted_by_pm.'%))';
                    $point->gained_as = "Individual";
                    ...
                    $point->project_id= $find_project_id->id;
                    $point->activity= '<a href="'.route('employees.show',$user_name->id).'">'.$user_name->name . '</a> started negotiation started Project : <a href="'.route('projects.show',$find_project_id->id).'">'.$find_project_id->project_name. '</a>, Client: <a href="'.route('clients.show',$find_project_id->client_id).'">'. $find_project_id->client_name->name. '</a> (Accpeted By PM('.$kpi->accepted_by_pm.'%))';
                    $point->gained_as = "Individual";
                    ...
                    $point->project_id= $find_project_id->id;
                    $point->activity= '<a href="'.route('employees.show',$user_name->id).'">'.$user_name->name . '</a> created the milestone breakdown Project : <a href="'.route('projects.show',$find_project_id->id).'">'.$find_project_id->project_name. '</a>, Client: <a href="'.route('clients.show',$find_project_id->client_id).'">'. $find_project_id->client_name->name. '</a> (Accpeted By PM('.$kpi->accepted_by_pm.'%))';
                    $point->gained_as = "Individual";
                    ...
                    $point->project_id= $find_project_id->id;
                    $point->activity= '<a href="'.route('employees.show',$user_name->id).'">'.$user_name->name . '</a> closed the deal Project : <a href="'.route('projects.show',$find_project_id->id).'">'.$find_project_id->project_name. '</a>, Client: <a href="'.route('clients.show',$find_project_id->client_id).'">'. $find_project_id->client_name->name. '</a> (Accpeted By PM('.$kpi->accepted_by_pm.'%))';
                    $point->gained_as = "Individual";
                    ...
                    $point->project_id= $find_project_id->id;
                    $point->activity= '<a href="'.route('employees.show',$user_name->id).'">'.$user_name->name . '</a> submitted the contact form for the project manager Project : <a href="'.route('projects.show',$find_project_id->id).'">'.$find_project_id->project_name. '</a>, Client: <a href="'.route('clients.show',$find_project_id->client_id).'">'. $find_project_id->client_name->name. '</a> (Accpeted By PM('.$kpi->accepted_by_pm.'%))';
                    $point->gained_as = "Individual";
                    ...
                    if ($find_deal_id->authorization_status == 1) {
                     ...
                     $point->project_id= $find_project_id->id;
                     $point->activity= '<a href="'.route('employees.show',$user_name->id).'">'.$user_name->name . '</a> for authorizing deal Project : <a href="'.route('projects.show',$find_project_id->id).'">'.$find_project_id->project_name. '</a>, Client: <a href="'.route('clients.show',$find_project_id->client_id).'">'. $find_project_id->client_name->name. '</a> (Accpeted By PM('.$kpi->accepted_by_pm.'%))';
                     $point->gained_as = "Individual";
                        ...
                        if($find_deal_id->lead_id != null)
             {
                 ...
                 $point->user_id= $lead->added_by;
                 $point->project_id= $find_project_id->id;
                 $point->activity= '<a href="'.route('employees.show',$user_name->id).'">'.$user_name->name . '</a> created the bid Project : <a href="'.route('projects.show',$find_project_id->id).'">'.$find_project_id->project_name. ', Client: <a href="'.route('clients.show',$find_project_id->client_id).'">'. $find_project_id->client_name->name. '</a>(Higher Single Deal('.$kpi->bonus_point.' points))';
                 $point->gained_as = "Individual";
                ...
                // dd($point);
                     ...
                     $point->user_id= $deal_qualified->updated_by;
                     $point->project_id= $find_project_id->id;
                     $point->activity= '<a href="'.route('employees.show',$user_name->id).'">'.$user_name->name . '</a> made the deal qualify Project : <a href="'.route('projects.show',$find_project_id->id).'">'.$find_project_id->project_name. ', Client: <a href="'.route('clients.show',$find_project_id->client_id).'">'. $find_project_id->client_name->name. '</a>(Higher Single Deal('.$kpi->bonus_point.' points))';
                     $point->gained_as = "Individual";
                     $point->points= $bonus_point;
                     ...
                     $point->user_id= $deal_short_code->updated_by;
                     $point->project_id= $find_project_id->id;
                     $point->activity= '<a href="'.route('employees.show',$user_name->id).'">'.$user_name->name . '</a> made the deal requirements defined Project : <a href="'.route('projects.show',$find_project_id->id).'">'.$find_project_id->project_name. ', Client: <a href="'.route('clients.show',$find_project_id->client_id).'">'. $find_project_id->client_name->name. '</a>(Higher Single Deal('.$kpi->bonus_point.' points))';
                     $point->gained_as = "Individual";
                     $point->points= $bonus_point;
                     ...
                     $point->user_id= $deal_proposal->updated_by;
                     $point->project_id= $find_project_id->id;
                     $point->activity= '<a href="'.route('employees.show',$user_name->id).'">'.$user_name->name . '</a> created the proposal Project : <a href="'.route('projects.show',$find_project_id->id).'">'.$find_project_id->project_name. ', Client: <a href="'.route('clients.show',$find_project_id->client_id).'">'. $find_project_id->client_name->name. '</a>(Higher Single Deal('.$kpi->bonus_point.' points))';
                     $point->gained_as = "Individual";
                     $point->points= $bonus_point;
                     ...
                     $point->user_id= $deal_negotiation_started->updated_by;
                     $point->project_id= $find_project_id->id;
                     $point->activity= '<a href="'.route('employees.show',$user_name->id).'">'.$user_name->name . '</a> started negotiation started Project : <a href="'.route('projects.show',$find_project_id->id).'">'.$find_project_id->project_name. ', Client: <a href="'.route('clients.show',$find_project_id->client_id).'">'. $find_project_id->client_name->name. '</a>(Higher Single Deal('.$kpi->bonus_point.' points))';
                     $point->gained_as = "Individual";
                     $point->points=$bonus_point;
                     ...
                     if($deal_milestone_breakdown != null)
                     {
                        ...
                        $point->user_id= $deal_milestone_breakdown->updated_by;
                        $point->project_id= $find_project_id->id;
                        $point->activity= '<a href="'.route('employees.show',$user_name->id).'">'.$user_name->name . '</a> created the milestone breakdown Project : <a href="'.route('projects.show',$find_project_id->id).'">'.$find_project_id->project_name. ', Client: <a href="'.route('clients.show',$find_project_id->client_id).'">'. $find_project_id->client_name->name. '</a>(Higher Single Deal('.$kpi->bonus_point.' points))';
                        $point->gained_as = "Individual";
                        $point->points= $bonus_point;
                     ...
                     $point->user_id= $deal_id->added_by;
                     $point->project_id= $find_project_id->id;
                     $point->activity= '<a href="'.route('employees.show',$user_name->id).'">'.$user_name->name . '</a> closed the deal Project : <a href="'.route('projects.show',$find_project_id->id).'">'.$find_project_id->project_name. ', Client: <a href="'.route('clients.show',$find_project_id->client_id).'">'. $find_project_id->client_name->name. '</a>(Higher Single Deal('.$kpi->bonus_point.' points))';
                     $point->gained_as = "Individual";
                     $point->points= $bonus_point;
                     ...
                     $point->user_id= $deal_id_contact->added_by;
                     $point->project_id= $find_project_id->id;
                     $point->activity= '<a href="'.route('employees.show',$user_name->id).'">'.$user_name->name . '</a> submitted the contact form for the project manager Project : <a href="'.route('projects.show',$find_project_id->id).'">'.$find_project_id->project_name. ', Client: <a href="'.route('clients.show',$find_project_id->client_id).'">'. $find_project_id->client_name->name. '</a>(Higher Single Deal('.$kpi->bonus_point.' points))';
                     $point->gained_as = "Individual";
                     $point->points= $bonus_point;
                    ...
                    //  $point->user_id= $user_name->id;
                    //  $point->project_id= $find_project_id->id;
                    //  $point->activity= '<a href="'.route('employees.show',$user_name->id).'">'.$user_name->name . '</a> for authorizing deal Project : <a href="'.route('projects.show',$find_project_id->id).'">'.$find_project_id->project_name. ', Client: <a href="'.route('clients.show',$find_project_id->client_id).'">'. $find_project_id->client_name->name. '</a>(Higher Single Deal('.$kpi->bonus_point.' points))';
                    //  $point->gained_as = "Individual";
                    //  $point->points= $earned_point;
  ...
  $monthly_deal = Deal::whereMonth('created_at', $currentMonth)->sum('amount');
            ...
            if($find_deal_id->lead_id != null)
            {
                ...
                $point->user_id= $lead->added_by;
                $point->project_id= $find_project_id->id;
                $point->activity= '<a href="'.route('employees.show',$user_name->id).'">'.$user_name->name . '</a> created the bid Project : <a href="'.route('projects.show',$find_project_id->id).'">'.$find_project_id->project_name. '</a>, Client: <a href="'.route('clients.show',$find_project_id->client_id).'">'. $find_project_id->client_name->name. '</a>Additional milestone reach '.$kpi->after_reach_amount. '%';
                $point->gained_as = "Individual";
               ...
               // dd($point);
                    ...
                    $point->user_id= $deal_qualified->updated_by;
                    $point->project_id= $find_project_id->id;
                    $point->activity= '<a href="'.route('employees.show',$user_name->id).'">'.$user_name->name . '</a> made the deal qualify deal Project : <a href="'.route('projects.show',$find_project_id->id).'">'.$find_project_id->project_name. '</a>, Client: <a href="'.route('clients.show',$find_project_id->client_id).'">'. $find_project_id->client_name->name. '</a>Additional milestone reach '.$kpi->after_reach_amount. '%';
                    $point->gained_as = "Individual";
                    ...
                    $point->user_id= $deal_short_code->updated_by;
                    $point->project_id= $find_project_id->id;
                    $point->activity= '<a href="'.route('employees.show',$user_name->id).'">'.$user_name->name . '</a> made the deal requirements defined Project : <a href="'.route('projects.show',$find_project_id->id).'">'.$find_project_id->project_name. '</a>, Client: <a href="'.route('clients.show',$find_project_id->client_id).'">'. $find_project_id->client_name->name. '</a>Additional milestone reach '.$kpi->after_reach_amount. '%';
                    $point->gained_as = "Individual";
                    ...
                    $point->user_id= $deal_proposal->updated_by;
                    $point->project_id= $find_project_id->id;
                    $point->activity= '<a href="'.route('employees.show',$user_name->id).'">'.$user_name->name . '</a> created the proposal Project : <a href="'.route('projects.show',$find_project_id->id).'">'.$find_project_id->project_name. '</a>, Client: <a href="'.route('clients.show',$find_project_id->client_id).'">'. $find_project_id->client_name->name. '</a>Additional milestone reach '.$kpi->after_reach_amount. '%';
                    $point->gained_as = "Individual";
                    ...
                    $point->user_id= $deal_negotiation_started->updated_by;
                    $point->project_id= $find_project_id->id;
                    $point->activity= '<a href="'.route('employees.show',$user_name->id).'">'.$user_name->name . '</a> started negotiation started Project : <a href="'.route('projects.show',$find_project_id->id).'">'.$find_project_id->project_name. '</a>, Client: <a href="'.route('clients.show',$find_project_id->client_id).'">'. $find_project_id->client_name->name. '</a>Additional milestone reach '.$kpi->after_reach_amount. '%';
                    $point->gained_as = "Individual";
                    ...
                    $point->user_id= $deal_milestone_breakdown->updated_by;
                    $point->project_id= $find_project_id->id;
                    $point->activity= '<a href="'.route('employees.show',$user_name->id).'">'.$user_name->name . '</a> created the milestone breakdown Project : <a href="'.route('projects.show',$find_project_id->id).'">'.$find_project_id->project_name. '</a>, Client: <a href="'.route('clients.show',$find_project_id->client_id).'">'. $find_project_id->client_name->name. '</a>Additional milestone reach '.$kpi->after_reach_amount. '%';
                    $point->gained_as = "Individual";
                    ...
                    $point->user_id= $deal_id->added_by;
                    $point->project_id= $find_project_id->id;
                    $point->activity= '<a href="'.route('employees.show',$user_name->id).'">'.$user_name->name . '</a> closed the deal Project : <a href="'.route('projects.show',$find_project_id->id).'">'.$find_project_id->project_name. '</a>, Client: <a href="'.route('clients.show',$find_project_id->client_id).'">'. $find_project_id->client_name->name. '</a>Additional milestone reach '.$kpi->after_reach_amount. '%';
                    $point->gained_as = "Individual";
                    ...
                    $point->user_id= $deal_id_contact->added_by;
                    $point->project_id= $find_project_id->id;
                    $point->activity= '<a href="'.route('employees.show',$user_name->id).'">'.$user_name->name . '</a> submitted the contact form for the project manager Project : <a href="'.route('projects.show',$find_project_id->id).'">'.$find_project_id->project_name. '</a>, Client: <a href="'.route('clients.show',$find_project_id->client_id).'">'. $find_project_id->client_name->name. '</a>Additional milestone reach '.$kpi->after_reach_amount. '%';
                    $point->gained_as = "Individual";
  ...
  $monthly_deal = Deal::whereMonth('created_at', $currentMonth)->sum('amount');
    ...
    // dd($kpi_settings);
     ...
     $point->user_id= $user_name->id;
    // / $point->project_id= $find_project_id->id;
     $point->activity= '<a href="'.route('employees.show',$user_name->id).'">'.$user_name->name . '</a> for achieving monthly target from $'.$value->generate_sales_from.' to $'.$value->generate_sales_to;
     $point->gained_as = "Individual";
     ...
     if ($monthly_deal > $kpi->generate_sales_above)
{
     ...
     $point->user_id= $user_name->id;
    // $point->project_id= $find_project_id->id;
     $point->activity= '<a href="'.route('employees.show',$user_name->id).'">'.$user_name->name . '</a> for achieving monthly target above $'.$kpi->generate_sales_above;
     $point->gained_as = "Individual";
