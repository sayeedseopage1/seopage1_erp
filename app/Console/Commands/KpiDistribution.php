...
class KpiDistribution extends Command
{
  ...
  $monthly_deal = Deal::whereMonth('created_at', $currentMonth)->sum('amount');
    ...
    // dd($kpi_settings);
     ...
     $point->user_id= $user_name->id;
    // / $point->project_id= $find_project_id->id;
     $point->activity= $user_name->name . ' for achieving monthly target from $'.$value->generate_sales_from.' to $'.$value->generate_sales_to;
     $point->gained_as = "Individual";
     ...
     if ($monthly_deal > $kpi->generate_sales_above)
{
     ...
     $point->user_id= $user_name->id;
    // $point->project_id= $find_project_id->id;
     $point->activity= $user_name->name . ' for achieving monthly target above $'.$kpi->generate_sales_above;
     $point->gained_as = "Individual";
